...
//		$this->user_id = $this->phpsession->get( 'id', 'stc' );
	...
	// 자료실 최근글표시
	function manual_new() {
		$sql = "select seq, update_date from sales_manual_basic order by seq desc";
		$query = $this->db->query( $sql );
		return $query->result_array();
	}

	// 포캐스팅 최근글표시
	function forcasting_new() {
		$sql = "select seq, update_date from sales_forcasting order by seq desc";
		$query = $this->db->query( $sql );
		return $query->result_array();
	}
	...
	// FAQ 최근글표시
	function faq_new() {
		$sql = "select seq, update_date from sales_faq_basic order by seq desc";
		$query = $this->db->query( $sql );
		return $query->result_array();
	}
	...
	// QNA 최근글표시
	function qna_new() {
		$sql = "select seq, update_date from sales_qna_basic order by seq desc";
		$query = $this->db->query( $sql );
		return $query->result_array();
	}

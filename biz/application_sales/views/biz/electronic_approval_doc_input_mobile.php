    ...
    <div style="text-align:left;font-size:20px;margin-bottom:20px;margin-top:20px;width:100%;font-weight:bold;line-height:25px;">
      ...
      <div>
        <!-- <table id="approver_line_table" class="basic_table">
          ...
          <tr>
            <td height=40 class="basic_td" bgcolor="f8f8f9" >결재</td>
      ...
      <div>
        <table class="basic_table">
          ...
          <tr>
             <td height=40 class="basic_td" bgcolor="f8f8f9">문서번호</td>
             <td colspan="2" class="basic_td">자동채번</td>
          </tr>
          <tr>
             <td class="basic_td" bgcolor="f8f8f9">기안일자</td>
             <td colspan="2" class="basic_td"><?php echo date("Y-m-d"); ?></td>
          </tr>
          <tr>
            <td class="basic_td" bgcolor="f8f8f9">기안부서</td>
            <td class="basic_td"><input type="hidden" name="writer_group" id="writer_group" value="<?php echo $group; ?>" /><?php echo $group; ?></td>
          </tr>
          <tr>
            <td height=40 class="basic_td" bgcolor="f8f8f9">참조자</td>
          ...
          <tr>
            <td class="basic_td" bgcolor="f8f8f9">기결재첨부</td>
            <td class="basic_td">
          ...
          <tr>
             <td height=40 class="basic_td" bgcolor="f8f8f9">문서제목</td>
...
<div id="select_approval_modal" class="searchModal">
	 <div class="search-modal-content">
						...
						<table class="basic_table">
								...
								<tr>
									<td class ="basic_td" align="left">
										 <span style="font-weight:bold;">결재방법</span>
										 <div>
											 <span>
												<input type="radio" name="approval_type" value="결재" checked />결재
												<input type="radio" name="approval_type" value="합의" />합의
								...
								<tr>
									<td class ="" align="center">
										 <div style="background-color:#f8f8f9;margin-top:20px;text-align:left;">
											 <table cellspacing="0">
											 	 	<td style="width:40%;padding:0;background-color:#F4F4F4;">사용자 결재선</td>
													...
													<td style="width:20%;padding:0;">
														 <button type="button" name="button" class="btn-common btn-style2" style="width:100%;height:100%" onclick="user_approval_line_delete();">삭제</button>
													</td>
											 	 </tr>
											 </table>
										 ...
										 <table cellspacing="0">
											 <td style="width:40%;padding:0;background-color:#F4F4F4;">사용자 결재선명</td>

											 <td style="width:40%;padding:0;">
												 <input type="text" id="approval_line_name" name="approval_line_name"class="input5" style="height:100%;">
											 </td>
											 <td style="width:20%;padding:0;">
												 <button type="button" class="btn-common btn-style2" style="width:100%;height:100%;" name="button" onclick="user_approval_line_save();">추가</button>
											 </td>
				 ...
				 <div style=" text-align: center; margin-top:10px;">
					 <button type="button" name="button" class="btn-common btn-color1" style="width:45%;" onClick="closeModal();">취소</button>
					 <button type="button" name="button" class="btn-common btn-color2" style="width:45%;" onClick="saveApproverLineModal();">등록</button>
				 </div>
	 </div>
</div>
<!-- 결제선 모달 끝 -->
  ...
  <script>
     ...
     function approver_add(){
        ...
        if(duplicate_check == true || $("#click_user").html() == undefined){
           ...
           html += "<td height=30>최종</td><td onclick='change_approval_type(this);' style='cursor:pointer;'>"+approval_type+"</td><td>"+click_html+"<input type='hidden' name='approval_line_seq' value='"+$("#click_user_seq").val()+"' /><input type='hidden' name='approval_line_type' value='"+approval_type+"' /></td>";
           html += "</tr>";

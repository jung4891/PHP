    ...
    <div class="content">
        <div class="content-1 contents" style="display:none;">
            <table width="100%" class="basic_table">
                <tr class="parallel">
                    <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;">병합</td>
                    <td width="85%" height="30" class="basic_td" align="left" style="font-weight:bold;" >
                        <input type="radio" name="parallel1" id="parallel1" value="Y" <?php if(isset($parallel1)){if($parallel1 == 'Y'){echo "checked";}} ?>/>예
                        <input type="radio" name="parallel1" id="parallel1" value="N" <?php if(isset($parallel1)){if($parallel1 == 'N'){echo "checked";}}else{ echo "checked";} ?>/>아니오
                    </td>
                </tr>
                <tr>
        ...
        <div class="content-2 contents" style="display:none;">
            <table width="100%" class="basic_table">
                <tr class="parallel">
                    <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;">병합</td>
                    <td width="85%" height="30" class="basic_td" align="left" style="font-weight:bold;" >
                        <input type="radio" name="parallel2" id="parallel2" value="Y" <?php if(isset($parallel2)){if($parallel2 == 'Y'){echo "checked";}} ?>/>예
                        <input type="radio" name="parallel2" id="parallel2" value="N" <?php if(isset($parallel2)){if($parallel2 == 'N'){echo "checked";}}else{ echo "checked";} ?>/>아니오
                    </td>
                </tr>
                <tr>
                    <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;">제목 </td>
        ...
        <div class="content-3 contents" style="display:none;">
            <table width="100%" class="basic_table">
                <tr class="parallel">
                    <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;">병합</td>
                    <td width="85%" height="30" class="basic_td" align="left" style="font-weight:bold;" >
                        <input type="radio" name="parallel3" id="parallel3" value="Y" <?php if(isset($parallel3)){if($parallel3 == 'Y'){echo "checked";}} ?>/>예
                        <input type="radio" name="parallel3" id="parallel3" value="N" <?php if(isset($parallel3)){if($parallel3 == 'N'){echo "checked";}}else{ echo "checked";} ?>/>아니오
                    </td>
                </tr>
                <tr>
                    <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;">제목 </td>
                ...
                <tr>
                    ...
                    <td width="85%" height="120" class="basic_td" align="left" style="font-weight:bold;" >
                        ...
                        <input type="button" value="추가" onclick="option_add();">  &nbsp; * 항목 drag&drop 순서변경 가능
        ...
        <div class="content-4 contents" style="display:none;">
            <table width="100%" class="basic_table">
                <tr class="parallel">
                    <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;">병합</td>
                    <td width="85%" height="30" class="basic_td" align="left" style="font-weight:bold;" >
                        <input type="radio" name="parallel4" id="parallel4" value="Y" <?php if(isset($parallel4)){if($parallel4 == 'Y'){echo "checked";}} ?>/>예
                        <input type="radio" name="parallel4" id="parallel4" value="N" <?php if(isset($parallel4)){if($parallel4 == 'N'){echo "checked";}}else{ echo "checked";} ?>/>아니오
                    </td>
                </tr>
                <tr>
                    <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;">제목 </td>
        ...
        <div class="content-5 contents" style="display:none;">
            <table width="100%" class="basic_table">
                <tr class="parallel">
                    <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;">병합</td>
                    <td width="85%" height="30" class="basic_td" align="left" style="font-weight:bold;" >
                        <input type="radio" name="parallel5" id="parallel5" value="Y" <?php if(isset($parallel5)){if($parallel5 == 'Y'){echo "checked";}} ?>/>예
                        <input type="radio" name="parallel5" id="parallel5" value="N" <?php if(isset($parallel5)){if($parallel5 == 'N'){echo "checked";}}else{ echo "checked";} ?>/>아니오
                    </td>
                </tr>
                <tr>
                    <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;">제목 </td>
        ...
        <div class="content-6 contents" style="display:none;">
            <table width="100%" class="basic_table">
                <tr class="parallel">
                    <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;">병합</td>
                    <td width="85%" height="30" class="basic_td" align="left" style="font-weight:bold;" >
                        <input type="radio" name="parallel6" id="parallel6" value="Y" <?php if(isset($parallel6)){if($parallel6 == 'Y'){echo "checked";}} ?>/>예
                        <input type="radio" name="parallel6" id="parallel6" value="N" <?php if(isset($parallel6)){if($parallel6 == 'N'){echo "checked";}}else{ echo "checked";} ?>/>아니오
                    </td>
                </tr>
                <tr>
        ...
        <div class="content-7 contents" style="display:none;">
            <table width="100%" class="basic_table">
                <tr class="parallel">
                    <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;">병합</td>
                    <td width="85%" height="30" class="basic_td" align="left" style="font-weight:bold;" >
                        <input type="radio" name="parallel7" id="parallel7" value="Y" <?php if(isset($parallel7)){if($parallel7 == 'Y'){echo "checked";}} ?>/>예
                        <input type="radio" name="parallel7" id="parallel7" value="N" <?php if(isset($parallel7)){if($parallel7 == 'N'){echo "checked";}}else{ echo "checked";} ?>/>아니오
                    </td>
                </tr>
                <tr>
                    <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;">제목 </td>
...
<script>
   ...
   $('.summernote').summernote({ placeholder: '설명을 입력해주세요', tabsize: 2, height: 180 });
    ...
    function ok(){
        ...
        if(tab_value == 1) { //텍스트
            ...
            var span = "<span style='cursor:pointer;' onclick='openPopup(this);' onmousedown='others(event,this);'><img src='<?php echo $misc;?>img/input.png' width='23' style='vertical-align:middle'>텍스트("+column_name+")</span>";
            ...
            var span = "<span style='cursor:pointer;' onclick='openPopup(this);' onmousedown='others(event,this);'><img src='<?php echo $misc;?>img/textbox.png' width='23' style='vertical-align:middle'>텍스트박스("+column_name+")</span>";
            span += "<input type='hidden' name='template' id='template"+tr+"' value='"+text+"'/>";
            ...
            var span = "<span style='cursor:pointer;' onclick='openPopup(this);' onmousedown='others(event,this);'><img src='<?php echo $misc;?>img/select.png' width='23' style='vertical-align:middle'>셀렉트("+column_name+")</span>";
            span += "<input type='hidden' name='template' id='template"+tr+"' value='"+text+"'/>";
            ...
            var span = "<span style='cursor:pointer;' onclick='openPopup(this);' onmousedown='others(event,this);'><img src='<?php echo $misc;?>img/radio.png' width='23' style='vertical-align:middle'>라디오("+column_name+")</span>";
            span += "<input type='hidden' name='template' id='template"+tr+"' value='"+text+"'/>";
            ...
            var span = "<span style='cursor:pointer;' onclick='openPopup(this);' onmousedown='others(event,this);'><img src='<?php echo $misc;?>img/checkbox.png' width='23' style='vertical-align:middle'>체크박스("+column_name+")</span>";
            span += "<input type='hidden' name='template' id='template"+tr+"' value='"+text+"'/>";
            ...
            var span = "<span style='cursor:pointer;' onclick='openPopup(this);' onmousedown='others(event,this);'><img src='<?php echo $misc;?>img/writebox.png' width='23' style='vertical-align:middle'>글상자("+column_name+")</span>";
            span += "<input type='hidden' name='template' id='template"+tr+"' value='"+text+"'/>";
            ...
            var span = "<span style='cursor:pointer;' onclick='openPopup(this);' onmousedown='others(event,this);'><img src='<?php echo $misc;?>img/component.png' width='23' style='vertical-align:middle'>컴포넌트("+column_name+")</span>";
            span += "<input type='hidden' name='template' id='template"+tr+"' value='"+text+"'/>";
        }

      ...
      <tr id="search_tr">
         <td align="left" valign="top">
            ...
            <?php if($_GET['mode'] == 'user') { ?>
                  <span class="search_title">결재상태&nbsp;</span>
            <?php } ?>
                  ...
                  <span class="search_title">문서양식&nbsp;<span>
                  ...
                  <span class="search_title">작성일</span>
        ...
        <?php if($_GET['mode'] == 'user') { ?>
                <td style="float:right;">
                  <div style='margin:20px 0px 0px 20px;text-align:left;'>
                    <input type="button" class="btn-common btn-color7" value="공문 작성" onclick="official_doc_input_view()" style="width:100px;margin-right:10px;"/>
...
$no--;
		...
		<tr>
			<td colspan="4" align="right" style="padding-top:20px;">
				<!--지원내용 추가 버튼-->
				<input type="button" class="btn-common btn-color4" style="width:70px;" value="취소" onclick="$('#approval_form').bPopup().close()">
			</td>
		</tr>
  </table>
</div>

...
<?php foreach ($list_val as $item) { ?>
				<tr onclick="ViewBoard('<?php echo $item['seq'];?>')">
					...
					<td align="right" style="color:#A1A1A1;"><?php echo $item['user_group'];?></td>
				</tr>
				<tr onclick="ViewBoard('<?php echo $item['seq'];?>')">
					<td align="left" style="color:#1C1C1C;font-weight:bold;"><?php echo $item['title'];?></td>
					<td align="right" style="color:#1C1C1C;font-weight:bold;"><?php echo $item['place'];?></td>
				</tr>

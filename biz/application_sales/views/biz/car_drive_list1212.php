    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="none_mobile">
      ...
      <tr>
        ...
        <td align="center" style="padding:0 5px;">
          <select class="select7" id="add_carname" name="add_carname" style="width:160px; height:23px;" onchange="find_add_car_a_km();">
        ...
        <td align="center" style="padding:0 5px;">
          <input type="text" class="input5" id="add_d_km" name="add_d_km" style="width:100%; height:18px;">
        </td>
        <td align="center" style="padding:0 5px;">
        ...
        <td align="center" style="padding:0 5px;">
          <input type="text" class="input5 datepicker" id="add_drive_date" name="add_drive_date" style="width:100%; height:18px;">
        </td>
        <td align="center" style="padding:0 5px;">
          <input type="text" class="input5 timepicker" id="add_d_time" name="add_d_time" style="width:100%; height:18px;">
        </td>
        <td align="center" style="padding:0 5px;">
          <input type="text" class="input5 timepicker" id="add_a_time" name="add_a_time" style="width:100%; height:18px;">
        </td>
        <td align="center" style="padding:0 5px;">
...
<td valign="top" style="padding:15px 0px 15px 0px">
    ...
    ?>
                <tr id="tr_<?php echo $item['seq'];?>" seq="<?php echo $item['seq'];?>" name="tr_list" <?php if($mobile=='true'){echo 'onclick="detail(this);"';} ?>>
                  ...
                  <td align="center">
                    <?php if($mobile=="false"){ ?>
                    <input type="text" class="input_border" id="a_km" name="a_km" value="<?php echo $item['a_km'];?>" style="width:70px; height:18px; text-align:center;" onfocusin="in_text_align(this);" onfocusout="out_text_align(this);" onchange="modifyInput(this);change_km(this);" title="<?php echo $item['a_km'];?>">km
                  <?php } else {
                    echo $item['a_km'].'km';
                  }?>

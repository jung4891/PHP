                                    ...
                                    <td width="100%" align="center" valign="top">
                                                   ...
                                                   <div class="content">
                                                      ...
                                                      <div class="content-2">
                                                         ...
                                                         <div class="content-2" style="width:100%">
                                                            <input type="button" class="btn-common btn-color1" value="초기화" onclick="reset();" style="margin-bottom:5px;">
                                                            <input type="button" class="btn-common btn-color1" value="미리보기" onclick="preview();" style="margin-bottom:5px;">
                                                            <input type="button" class="btn-common btn-color2" value="양식작성기 서식" onclick="form_save_modal_open();" style="margin-bottom:5px;width:110px;">
                                                            <span style="float:right;">
                                                               <img src="<?php echo $misc;?>img/input.png" width="23" style="vertical-align:middle"> 텍스트
                                                               <img src="<?php echo $misc;?>img/textbox.png" width="23" style="vertical-align:middle"> 텍스트박스
                                                               <img src="<?php echo $misc;?>img/select.png" width="20" style="vertical-align:middle"> 셀렉트
                                                               <img src="<?php echo $misc;?>img/radio.png" width="20" style="vertical-align:middle"> 라디오
                                                               <img src="<?php echo $misc;?>img/checkbox.png" width="20" style="vertical-align:middle"> 체크박스
                                                               <img src="<?php echo $misc;?>img/writebox.png" width="20" style="vertical-align:middle"> 글상자
                                                               <img src="<?php echo $misc;?>img/component.png" width="20" style="vertical-align:middle"> 컴포넌트
                                                               <img src="<?php echo $misc;?>img/line.png" width="20" style="vertical-align:middle"> 구분선
                                                            </span>
                                                            <br>
                                                            <?php for($i=1; $i<=10; $i++){
                                                               echo "<input type='button' class='form_btn' value='{$i}칸' style='margin-left:2px;' onclick='form_add($i);'>";
                                                            } ?>
                                       ...
                                       <div id="modal" class="searchModal">
                                          <div class="search-modal-content">
                                             ...
                                             <table width="100%" class ="basic_table">
                                                <tr>
                                                   <td height="40" width="15%" class="basic_td row-color1" align="center" style="font-weight:bold;">제목</td>
                                                   <td width="35%" class="basic_td" align="left">
                                                      <input type="text" id ="multi_subject" class="input-common" style="width:100%" />
                                                   </td>
                                                </tr>
                                                <tr>
                                                   <td height="40" width="15%" class="basic_td row-color1" align="center" style="font-weight:bold;">개수</td>
                                                   <td width="35%" class="basic_td" align="left">
                                                      <input type="text" id ="multi_num" class="input-common" value="1" />
                                                   </td>
                                                </tr>
                                                <tr>
                                                   <td height="40" width="15%" class="basic_td row-color1" align="center" style="font-weight:bold;">넓이</td>
                                                   <td width="35%" class="basic_td" align="left">
                                                      <input type="text" id ="multi_width" class="input-common" /><span id ="multi_width_comment"></span>
                                                   </td>
                                                </tr>
                                                <tr>
                                                   <td height="40" width="15%" class="basic_td row-color1" align="center" style="font-weight:bold;">합계</td>
                                                   <td width="35%" class="basic_td" align="left">
                                       ...
                                       <div id="line_modal" class="searchModal">
                                          <div class="search-modal-content">
                                             ...
                                             <table width="100%" class ="basic_table">
                                                ...
                                                <tr>
                                                   <td height="40" width="15%" class="basic_td row-color1" align="center" style="font-weight:bold;">설명</td>
                                                   <td width="35%" class="basic_td" align="left">
                                                      <input type="text" id ="line_comment" class="input-common" />
                                                   </td>
                                                </tr>
                                                <tr>
                                                   <td height="40" width="15%" class="basic_td row-color1" align="center" style="font-weight:bold;">높이</td>
                                                   <td width="35%" class="basic_td" align="left">
                                          ...
                                          <div class="search-modal-content" style='height:auto; min-height:400px;overflow: auto;'>
                                             <h2>사용자 선택</h2>
                                                <div style="margin-top:30px;height:auto; min-height:300px;overflow:auto;">
                                                   <input type="button" class="btn-common btn-color1" value="조직원 전체 선택" style="float:right;margin-bottom:5px;width:120px;" onclick="select_user_add('all');" >
                                       ...
                                       <div id="form_save_modal" class="searchModal" >
                                          <div class="search-modal-content" style="width:50%">
                                             ...
                                             <table id="form_save_table" width="100%" class ="basic_table">
                                                <tr>
                                                   <td width="15%"height="40" class="basic_td row-color1" align="center" style="font-weight:bold;">서식명</td>
                                                   <td width="35%" class="basic_td" align="left">
                                             ...
                                             <table id="form_management_list" width="100%" class ="basic_table" style="margin-top:50px;">
                                                <tr bgcolor="#f8f8f9">
                                                   ...
                                                   <td width="15%" class="basic_td" align="center" style="font-weight:bold;">서식명</td>
                                                ...
                                                if(!empty($form_management)){
                                                   foreach($form_management as $form_m){ ?>
                                                      <tr>
                                                         ...
                                                         <button type="button" class="btn-common btn-color1" onclick="form_apply(this);" style="width:60px;">적용</button>
                                                         <button type="button" class="btn-common btn-color2" onclick="form_change(<?php echo $form_m['seq']; ?>,'<?php echo $form_m['form_name']; ?>')" style="width:60px;">수정</button>
                                                         </td>
                                                      </tr>
                                                <?php
                                                   }
                                                }else{
                                                   echo "<tr><td height='40' colspan=3 align='center'> - 검색 결과가 존재하지 않습니다.</td></tr>";
                                                }
                                                ?>
                                             </table>
                                                   ...
                                                   <div class="content">
                                                      <div class="content-1">
                                                         ...
                                                         <table width="100%" class ="basic_table">
                                                            ...
                                                            <tr >
                                                               ...
                                                               <td width="35%" class="basic_td" align="left" style="font-weight:bold;" >
                                                                  <input type="radio" name="template_type" value="내부결제" onclick="$('#approval_info_check').val('N');" <?php if($view_val['template_type'] == "내부결제"){echo 'checked';} ?>  />내부결제
                                                                  <input type="radio" name="template_type" value="협조문" onclick="$('#approval_info_check').val('N');" <?php if($view_val['template_type'] == "협조문"){echo 'checked';} ?> />협조문
                                                               </td>
                                                               <td height="40" width="15%" class="basic_td row-color1" align="center" style="font-weight:bold;" >
                                                                  사용유무
                                                               </td>
                                                               <td width="35%" class="basic_td" align="left" style="font-weight:bold;" >
                                                                  <input type="radio" name="template_use" value="Y" onclick="$('#approval_info_check').val('N');" <?php if($view_val['template_use'] == "Y"){echo 'checked';} ?>  />유
                                                                  <input type="radio" name="template_use" value="N" onclick="$('#approval_info_check').val('N');" <?php if($view_val['template_use'] == "N"){echo 'checked';} ?> />무
                                                               </td>
                                                            </tr>
                                                            <tr >
                                                               <td height="40" width="15%" class="basic_td row-color1" align="center" style="font-weight:bold;" >
                                                            ...
                                                            <tr >
                                                               ...
                                                               <td width="85%" height="40" colspan=3 class="basic_td" align="left" style="font-weight:bold;" >
                                                                  <select id="default_approval_line" name="default_approval_line" class="select-common" onchange="click_user_approval_line(this.value);$('#approval_info_check').val('N');" style="width:256px;">
                                                                     <option value="N" <?php if($view_val['default_approval_line'] == "N"){echo 'selected';} ?>>결재선 설정 안함(기안문 작성 시 설정)</option>
                                                                     <?php foreach($approver_line as $al){
                                                                        echo "<option value='{$al['seq']}'";
                                                      ...
                                                      <div class="content-2">
                                                         ...
                                                         <div class="content-2" style="width:100%">
                                                            ...
                                                            <input type="button" class='form_btn' value="구분선" style='margin-left:2px;' onclick="form_add('line');" />
...
<script>
   ...
   function others(e,obj){
      ...
      if ((e.button == 2) || (e.which == 3)) {
         ...
         $("#popup_td").val($(obj).closest('td').attr('id'));//팝업 띄운 td 저장해놓기
         ...
         for (j = 0; j < template.length; j++) {//td
            ...
            for(a = j; a <=j+parrallel_num; a++){
               ...
               if(type == 0){ //구분선
                  ...
                  if(template_info[4] == 1 || template_info[4] == 2 ||template_info[4] == 3  ){ //숫자,금액은 오른쪽 정렬~~~
   ...
   function approval_info_save(){
      ...
      if('<?php echo $mode; ?>' == "input"){ //등록일때
         ...
         if(tdLength!=templateLength){
            alert("양식내용 중 항목이 다 채워지지 않아 미사용으로 저장됩니다.");
   ...
   //초기화
   function reset(){
      if(confirm("기존에 작성한 양식 작성기가 초기화 됩니다. 초기화하시겠습니까?")){
         $("#form_table").html("");
      }else{
         return false;
      }
   ...
   function form_apply(obj){
      if(confirm("기존에 작성하신 양식작성기가 초기화되고 해당 서식으로 적용 됩니다. 적용 하시겠습니까?")){

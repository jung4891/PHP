...
<div align="center">
	<div class="dash1-1">
		<table width="95%" height="100%" border="0" cellspacing="0" cellpadding="0" class="dash_tbl1-1">
          ...
          <input type="button" class="btn-common btn-color4" value="삭제" onClick="javascript:chkForm(1);return false;" style="float:right;">
					<input type="button" class="btn-common btn-color4" value="수정" onClick="modify(<?php echo $view_val['seq']; ?>)" style="float:right;margin-right:10px;">
				<?php } else {  ?>

...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="dash_tbl1-1">
      ...
      <tr height="5%">
           <?php if($type != "admin"){
                   ...
                   if($no_read_cnt_w[0]['cnt'] > 5){
                     $no_read_cnt_w[0]['cnt'] = '5over';
                   } ?>
                  ...
                  <td class="dash_title">
                    ...
                    <div class="main_title">
                      <a onclick ="moveList('wage')" style='cursor:pointer;margin-right:10px;color:<?php if($type == "wage"){echo "#1C1C1C";}else{echo "#DEDEDE";}?><?php if($type != "wage"){echo ";font-weight:normal";}?>'>연봉계약서</a>
                      <?php if($no_read_cnt_w[0]['cnt']!=0){ ?>
                      <div class="cnt">
                        <img src="<?php echo $misc ?>img/cnt_<?php echo $no_read_cnt_w[0]['cnt']; ?>.svg" width="20">
                      </div>
                      <?php } ?>
                    </div>
                  </td>
              ...
              <tr>
                <td style="font-weight:bold;vertical-align:middle;">
                  <div style="float:left">
                    ...
                    <span class="search_title">양식명&nbsp</span>
                    ...
                    <span class="search_title">기안자&nbsp;</span>
                  ...
                  <div style="float:right">
                    ...
                    <button class="read_btn btn-style5" style="float: right;display:inline;" type="button"name="button" onclick="all_read();">전체 읽음</button>
                  </div>
                </td>
              </tr>
            </table>
      ...
      <tr>
        <td>
           ...
           <div style="width:fit-content;margin-top:10px;">
              ...
              <input type="button" class="btn-common btn-updownload" style="padding-left:20px;width:auto;" value="엑셀 다운로드" onclick="excelDownload('excelTable');">
      ...
      <!-- <tr height="10%"> -->
        ...
        <td valign="top" style="padding:1px 0px 15px 0px">
        	<table class="list_tbl list" align="center" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
            ...
            <tr class="t_top row-color1">
              ...
              <?php if($type == "standby" || $type == "completion" || $type == "back" || $type == "reference" || $type == "wage"){?>
              ...
              <?php }else if($type == "completion" || $type == "back" ||$type == "reference" || $type == "admin" || $type == "wage"){?>
              ...
              if(empty($view_val) != true){
                 ...
                 for($i = $start_row; $i<$start_row+$end_row; $i++){
                    if(!empty( $view_val[$i])){
                       ...
                       if($type == "standby" || $type == "completion" || $type == "back" || $type == "reference" || $type == "wage"){
                    ...
                    if($type == "standby"){
                          ...
                          echo "</td>";
                    }else if($type == "completion" || $type == "back" ||$type == "reference" || $type=="admin" || $type == "wage"){
      ...
      <!-- 위임 있을 경우 -->
          ...
          <tr height="30%">
          <td valign="top" style="padding:1px 0px 15px 0px">
          <table class="list_tbl list" align="center" width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:50px;">
          <colgroup>
            <col width="10%">
            <col width="4%">
            <col width="6%">

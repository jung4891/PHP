           ...
           <?php if($type != "admin"){
                  ...
                  <td class="dash_title">
                    <div class="main_title">
                      <a onclick ="moveList('standby')" style='cursor:pointer;margin-right:10px;color:<?php if($type == "standby"){echo "#1C1C1C";}else{echo "#DEDEDE";}?>'>결재대기함</a>
                    ...
                    <div class="main_title">
                      <a onclick ="moveList('progress')" style='cursor:pointer;margin-right:10px;color:<?php if($type == "progress"){echo "#1C1C1C";}else{echo "#DEDEDE";}?>'>결재진행함</a>
                    ...
                    <div class="main_title">
                      <a onclick ="moveList('completion')" style='cursor:pointer;margin-right:10px;color:<?php if($type == "completion"){echo "#1C1C1C";}else{echo "#DEDEDE";}?>'>완료문서함</a>
                    ...
                    <div class="main_title">
                      <a onclick ="moveList('back')" style='cursor:pointer;margin-right:10px;color:<?php if($type == "back"){echo "#1C1C1C";}else{echo "#DEDEDE";}?>'>반려문서함</a>
                    ...
                    <div class="main_title">
                      <a onclick ="moveList('reference')" style='cursor:pointer;margin-right:10px;color:<?php if($type == "reference"){echo "#1C1C1C";}else{echo "#DEDEDE";}?>'>참조/열람문서함</a>

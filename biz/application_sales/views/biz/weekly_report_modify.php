...
function chkForm(type) {
    if (type == 1) {
        ...
        var request_url = "<?php echo site_url(); ?>/biz/weekly_report/weekly_report_modify_action";
        var response_url = "<?php echo site_url(); ?>/biz/weekly_report/weekly_report_list";

             ...
             <!--등록-->
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                  	<td height="60" align="center" bgcolor="f8f8f9" style="font-weight:bold;">*회의실 명</td>
                    <td align="left" class="t_border" style="padding-left:10px;"><input name="room_name" type="text" class="input7" id="room_name"/></td>
                 </tr>
                 <tr>
                    <td colspan="2" height="1" bgcolor="#e8e8e8"></td>
                  </tr>
                 <tr>
                    <td height="60" align="center" bgcolor="f8f8f9" style="font-weight:bold;">*위치</td>
                    <td align="left" class="t_border" style="padding-left:10px;"><input name="location" type="text" class="input7" id="location"/></td>
                  </tr>

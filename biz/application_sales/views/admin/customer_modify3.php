...
<form name="cform" action="<?php echo site_url();?>/admin/customer/customer_input_action3" method="post" enctype="multipart/form-data" onSubmit="javascript:chkForm();return false;">
              ...
              <tr>
              	<td height="40">
                   <ul style="list-style:none; padding:0; margin:0;">
                    ...
                    <li style="float:left;"><a href="<?php echo site_url();?>/admin/customer/customer_view3/<?php echo $seq;?>"><img src="<?php echo $misc;?>img/sales_tab_3_on.jpg" /></a></li>
              ...
              <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;"><?php if($view_val['file_changename']) {?><a href="<?php echo site_url();?>/admin/customer/customer_download3/<?php echo $seq;?>/<?php echo $view_val['file_changename'];?>"><?php echo $view_val['file_realname'];?></a><?php } else {?>파일없음<?php }?> <input name="cfile" type="file" id="cfile"/> </td>
                  </tr>  

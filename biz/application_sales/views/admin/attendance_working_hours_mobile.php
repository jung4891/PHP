...
<?php	}else{
				...
				<tr>
					<td bgcolor="#F4F4F4" style="font-weight:bold;">소정근로시간<br>(누적)</td>
					<td><?php echo $wd['work_hour'] ?></td>
				</tr>
				<tr>
					<td bgcolor="#F4F4F4" style="font-weight:bold;">소정외근로시간<br>(누적)</td>
					<td><?php echo $wd['over_time'] ?></td>
				</tr>
				<tr>
					<td bgcolor="#F4F4F4" style="font-weight:bold;">총근로시간<br>(누적)</td>
					<td><?php echo $wd['total_time'] ?></td>
				</tr>
				<tr>
					<td bgcolor="#F4F4F4" style="font-weight:bold;">소정근로시간<br>(잔여)</td>
					<td><?php echo $wd['rest_worktime'] ?></td>
				</tr>
				<tr>
					<td bgcolor="#F4F4F4" style="font-weight:bold;">소정외근로시간<br>(잔여)</td>

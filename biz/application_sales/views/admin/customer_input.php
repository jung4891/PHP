		...
		<!-- 타이틀 부분 시작 -->
          ...
          <!--//탭-->
              <tr>
                <td valign="top">
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;">
											<input name="company_name" type="text" class="input2" id="company_name"/>
										</td>
                    <td height="40" align="center" bgcolor="f8f8f9" style="font-weight:bold;" class="t_border">법인번호</td>
                    <td align="left" class="t_border" style="padding-left:10px;">
											<input name="rnum" type="text" class="input2" id="rnum" onclick="checkNum(this);" onKeyUp="checkNum(this);"/>
										</td>
                  </tr>
                  	...
                  	<td height="40" align="center" bgcolor="f8f8f9" style="font-weight:bold;">*사업자번호('-'빼고 입력)</td>
										 ...
										 <!-- <td>
											 <div class="box-file-input">
												 <label>
													 <input type="file" name="cfile" class="file-input" accept="image/*" id="cfile">
												 </label>
												 <span class="filename">파일을 선택해주세요. (용량제한 200MB)</span>
											 </div>
										 </td> -->


                     <td align="left" class="t_border" style="padding-left:10px;">
											 <input name="cnum" type="text" class="input2" id="cnum" onclick="checkNum(this);" onKeyUp="checkNum(this);" maxlength="10"/>
											 <div style="width:80px;">
												 <label>
													 <!-- <img src="<?php echo $misc;?>img/dashboard/btn/file_upload.png" onclick="$('#cnum_file').click()" style="cursor:pointer; width:70px;height:20px;"> -->
													 <input type="file" name="cnum_file" id="cnum_file" accept="image/*" >
												 </label>
												 <!-- <span>선택된 파일 없음</span> -->
											 </div>
										 </td>
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
											<input name="represent_name" type="text" class="input2" id="represent_name"/>
										</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;">
											<input name="company_category" type="text" class="input2" id="company_category"/>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;">
											<input name="company_sector" type="text" class="input2" id="company_sector"/>
											<span style="color:#999; font-size:10px;">사업자등록기준</span>
										</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;">
											<input name="establish_date" type="date" class="input2" id="establish_date" style="float:left;" />
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;"><input name="recommand_name" type="text" class="input2" id="recommand_name"/></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
                    <input name="cnum_flag" type="radio" value="Y" checked style=" float:left;" />
										<span style=" display:block; float:left; line-height:18px; padding:0 5px;">(유)</span>
										<select name="cnum_part1" id="cnum_part1" class="select7" style="float:left; margin-right:10px;">
                      <option value="001">국내(법인-일반)</option>
                      <option value="002">국내(개인)</option>
                    </select>
										<input name="cnum_flag" type="radio" value="N" style="float:left;" /> <span style=" display:block; float:left; line-height:18px; padding:0 5px;">(무)</span>
										<select name="cnum_part2" id="cnum_part2" class="select7" style="float:left;">
                  ...
                  <tr>
                    ...
                    <span style="display:block; line-height:35px;">
											<input name="company_post" type="text" class="input2" id="company_post" readonly/>
											<input type="button" value="우편번호" class="button" onclick="javascript:openDaumPostcode();" style="cursor:pointer;"/>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input name="company_addr1" type="text" class="input2" id="company_addr1" readonly/>
										</span>
                    <span style="display:block; line-height:35px; height:30px;">
											<input name="company_addr2" type="text" class="input2" style="width:615px;" id="company_addr2"/>
										</span>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
                    <span style="display:block; line-height:35px;">
											<input name="post_post" type="text" class="input2" id="post_post" readonly/>
											<input type="button" value="우편번호" class="button" onclick="javascript:openDaumPostcode2();" style="cursor:pointer;"/>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input name="post_addr1" type="text" class="input2" id="post_addr1" readonly/>
										</span>
                    <span style="display:block; line-height:35px; height:30px; float:left;">
											<input name="post_addr2" type="text" class="input2" style="width:615px;" id="post_addr2"/>
										</span>
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
											<input name="represent_tel" type="text" class="input2" id="represent_tel" onclick="checkNum(this);" onKeyUp="checkNum(this);"/>
											<span style="color:#999; font-size:10px;">예) 020000000</span>
										</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;">
											<input name="represent_handphone" type="text" class="input2" id="represent_handphone" onclick="checkNum(this);" onKeyUp="checkNum(this);"/>
											<span style="color:#999; font-size:10px;">예) 01000000000</span>
										</td>
                    <td height="40" align="center" bgcolor="f8f8f9" class="t_border" style="font-weight:bold;">*대표 FAX번호</td>
                    <td align="left" class="t_border" style="padding-left:10px;">
											<input name="represent_fax" type="text" class="input2" id="represent_fax" onclick="checkNum(this);" onKeyUp="checkNum(this);"/>
										</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
											<input name="represent_email" type="text" class="input2" id="represent_email"/>
										</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;">
											<input name="bnum" type="text" class="input2" id="bnum" onclick="checkNum(this);" onKeyUp="checkNum(this);"/>
											<input type="file" name="bnum_file" id="bnum_file"></td>
                    <td height="40" align="center" bgcolor="f8f8f9" class="t_border" style="font-weight:bold;">예금주</td>
                    <td align="left" class="t_border" style="padding-left:10px;">
											<input name="deposit_name" type="text" class="input2" id="deposit_name"/></td>
                  </tr>
              ...
              <!--버튼-->
               <tr>
                <td align="center">
									<input type="image" src="<?php echo $misc;?>img/dashboard/btn/btn_next.png" width="64" height="31" style="cursor:pointer" onclick="javascript:chkForm();return false;"/> <a href="<?php echo site_url();?>/admin/customer/customer_list">

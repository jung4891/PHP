...
<body>
  ...
  document.mform.action = "<?php echo site_url();?>/tech/board/network_map_list";
  ...
  ?>
		<form name="mform" action="<?php echo site_url();?>/tech/board/network_map_list" method="get" onkeydown="if(event.keyCode==13) return GoSearch();">
     ...
     <div class="menu_div">
   		...
   		<a class="menu_list" onclick ="moveList('board/network_map_list')" style='color:#0575E6'>구성도</a>

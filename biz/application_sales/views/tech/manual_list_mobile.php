...
<body>
  ...
  document.mform.action = "<?php echo site_url();?>/tech/board/manual_list";
  ...
  function moveList(page){
     location.href="<?php echo site_url();?>/tech/board/"+page;
  }
  </script>
	<?php
  ...
  ?>
		<form name="mform" action="<?php echo site_url();?>/tech/board/manual_list" method="get" onKeyDown="if(event.keyCode==13) return GoSearch();">
     ...
     <div class="menu_div">
   		<a class="menu_list" style='color:#0575E6'>자료실</a>
   		<a class="menu_list" onclick ="moveList('faq_list')" style='color:#B0B0B0'>FAQ</a>
   	</div>
...
<?php } ?>
  ...
  function ViewBoard (seq){
  	document.mform.action = "<?php echo site_url();?>/tech/board/manual_view";

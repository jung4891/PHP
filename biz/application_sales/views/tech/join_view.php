    ...
    <td align="center" valign="middle"><table style="background-color:#FFF; padding:20px; opacity:0.85;" width="740" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="center"><table width="550" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><input type="text" name="company_num" id="company_num" placeholder="사업자등록번호('-' 제외하고 입력)" class="login_input" onClick="checkNum(this);" onKeyUp="checkNum(this);" maxlength="10"></td>
          ...
          <tr>
           <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td>이용약관</td>
                <td align="right"><a href="#" onClick="window.open('<?php echo base_url();?>/design/agreement01.htm','','width=550,height=565,resizable=no, scrollbar=no,left=100,top=200');return false" target="space"><img src="<?php echo $misc;?>img/btn_detail.jpg" width="83" height="18"></a></td>
              </tr>
            </table></td>
            <td width="20"></td>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td>정보보호정책</td>
                <td align="right"><a href="#" onClick="window.open('<?php echo base_url();?>/design/agreement02.htm','','width=550,height=565,resizable=no, scrollbar=no,left=100,top=200');return false" target="space"><img src="<?php echo $misc;?>img/btn_detail.jpg" width="83" height="18"></a></td>
              </tr>
            </table></td>
          </tr>
        </table></td>

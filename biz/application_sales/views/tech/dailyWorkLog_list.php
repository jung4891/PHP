...
//	}
	...
	document.mform.action = "<?php echo site_url();?>/tech/board/dailyWorkLog_list";
...
<body>
	...
	<div align="center">
	<div class="dash1-1">
	<form name="mform" action="<?php echo site_url();?>/tech/board/dailyWorkLog_list" method="get" onKeyDown="if(event.keyCode==13) return GoSearch();">
	...
	<td align="left" valign="bottom">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:70px;">
			<tr>
				...
				<td align="right">
					<a href="<?php echo site_url();?>/tech/board/dailyWorkLog_input">
						...
						if ($count > 0) {
							...
							foreach ( $list_val as $item ) {
								...
								<tr onMouseOver="this.style.backgroundColor='#FAFAFA'" onMouseOut="this.style.backgroundColor='#fff'">
									...
									<td align="center"><a href="JavaScript:ViewBoard('<?php echo $item['seq'];?>')"><?php echo $item['user_duty'].' '.$item['user_name'].' 일일업무일지 ('.date('Y년m월d일', strtotime($item['log_date'])).')';?></a></td>
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/tech/board/dailyWorkLog_view";

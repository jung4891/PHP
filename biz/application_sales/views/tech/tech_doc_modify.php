                    ...
                    <td>
                      <table id="input_table" width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td width="35%" style="padding-left:10px;" class="t_border">
                            <input type="date" name="income_time" id="income_time" class="input2" value="<?php echo substr($view_val['income_time'], 0, 10); ?>" <?php if(isset($schedule)){echo "readonly";} ?>>
                          </td>
                          <td width="15%" height="40" align="center" bgcolor="f8f8f9" style="font-weight:bold;" class="t_border">작업종료일</td>
                          <td width="35%" style="padding-left:10px;" class="t_border">
                            <input type="date" name="end_work_day" id="end_work_day" class="input2" value="<?php
                        ...
                        <tr>
                          ...
                          <td width="35%" style="padding-left:10px;" class="t_border">
                            <select name="cover" id="cover" class="input2" style="height:23px;">
                        ...
                        ?>
                            ...
                            <tr id="main_insert_field_<?php echo $i; ?>">
                              ...
                              <td width="35%" style="padding:10px;" class="t_border" class="t_border">
                                <input type="text" name="customer_manager[]" id="customer_manager" class="input2 customer_manager" value="<?php echo $arr_manager[$i] ?>">
                              ...
                              <td width="35%" style="padding:10px;" class="t_border">
                                <input type="text" name="manager_mail[]" id="manager_mail" class="input2 manager_mail" value="<?php echo $arr_mail[$i] ?>">
                              </td>
                              <?php if ($i == 0) { ?>
                        ...
                        <tr>
                          ...
                          <td style="padding-left:10px;" class="t_border">
                            <input type="eu-time" name="start_time" id="start_time" class="input2" value="<?php echo substr($view_val['start_time'],0,5); ?>" autocomplete="off"  <?php if(isset($schedule)){echo "readonly";} ?>/>
                          </td>
                          <td align="center" bgcolor="f8f8f9" style="font-weight:bold;" class="t_border">종료시간</td>
                          <td style="padding:10px;" class="t_border">
                            <input type="eu-time" name="end_time" id="end_time" class="input2" value="<?php echo substr($view_val['end_time'],0,5); ?>" autocomplete="off"  <?php if(isset($schedule)){echo "readonly";} ?>/>
                          </td>
                        </tr>
<?php if(isset($schedule)){
        if( ( $schedule['s_file_realname']!='' || $schedule['start_reason']!='' ) && ( $schedule['e_file_realname']!='' || $schedule['end_reason']!='' ) ){ ?>
                        ...
                        <tr>
                          <td colspan="2" height="40" align="center" bgcolor="f8f8f9" style="font-weight:bold;" class="t_border">
                          ...
                          <td align="center" bgcolor="f8f8f9" style="font-weight:bold;" class="t_border">
  ...
  <?php }
                        ...
                        <tr>
                          ...
                          <td style="padding-left:10px;" class="t_border">
                            ...
                            <input type="hidden" name="engineer_seq" id="engineer_seq" class="input2" value="<?php echo $view_val['engineer_seq']; ?>" />
                          </td>
                          ...
                          ?>
                            <tr class="addRow">
                              <td height="40" align="center" bgcolor="f8f8f9" style="font-weight:bold;" class="t_border">
                                <input type="date" name="work_day_s[]" id="work_day_s" value="<?php echo $date[0]; ?>">
                                <br>
                                ~
                                <br>
                                <input type="date" name="work_day_e[]" id="work_day_e" value="<?php if(!empty($date[1])){ echo $date[1]; }else{ echo $date[0]; } ?>">
                                <br>
                                <input type="eu-time" name="work_time_s[]" id="work_time_s" autocomplete="off" style="margin-right:5%;" size="2" value="<?php echo $time[0]; ?>">
                                <input type="eu-time" name="work_time_e[]" id="work_time_e" autocomplete="off" style="margin-left:5%;" size="2" value="<?php echo $time[1]; ?>">
                              </td>
                              <td colspan="4" height="40" align="center" style="font-weight:bold; padding: 12px; " class="t_border">
                                <textarea rows="5" style="width:95%; max-width:720px;border-radius:12px;" name="work_text[]" id="work_text" value="<?php echo $process_txt[$i]; ?>"><?php echo $process_txt[$i]; ?></textarea>
                               </td>
                            </tr>
                            <?php
                        }
                    ...
                    <!-- 정기점검2 -->
                        ...
                        <td colspan="4" height="40" align="center" style="font-weight:bold; padding: 12px; " class="t_border">
                          <textarea rows="5" style="width:95%; max-width:720px; border-radius:12px;" name="comment" id="comment" value="<?php echo  $view_val['comment']; ?>"><?php echo  $view_val['comment']; ?></textarea>
                        </td>
                        <tr>
                          <td colspan="5" height="1" bgcolor="#797c88"></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td colspan="3" style="padding:10px;" class="t_border" >
                          <textarea rows="3" style="width:95%;max-width:720px;border-radius:12px;" name="request" id="request"><?php if (!empty($request)){ echo $request['contents']; } ?></textarea>
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td colspan="3" style="padding:10px;" class="t_border" >
                          <textarea rows="3" style="width:95%;max-width:720px;border-radius:12px;" name="issue" id="issue"><?php if (!empty($issue)){echo $issue['contents'];}?></textarea>
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td class="t_border" style="padding-left:10px;" colspan="3"><?php if ($view_val['file_changename']) { ?><a href="<?php echo site_url(); ?>/tech/tech_board/tech_doc_download/<?php echo $seq; ?>/<?php echo $view_val['file_changename']; ?>"><?php echo $view_val['file_realname']; ?></a> <a href="javascript:filedel('<?php echo $seq; ?>','<?php echo $view_val['file_changename']; ?>');"><img src="<?php echo $misc; ?>img/del.png" width="8" height="8" /></a>&nbsp;&nbsp;<input name="cfile" id="cfile" type="file" size="78" disabled><?php } else { ?><input name="cfile" type="file" size="78"> <span class="point0 txt_s">(용량제한 100MB)<?php } ?> </td>
                        </tr>
                  ...
                  <tr>
                    <td align="center">
                      <!--지원내용 추가 버튼-->
                      <img src="<?php echo $misc; ?>img/dashboard/btn/btn_content_add.png" id="addRowBtn" height="35" style="cursor:pointer" onclick="addRow('input_table');change_w2field();return false;" />
                      ...
                      <input type="image" src="<?php echo $misc; ?>img/dashboard/btn/btn_adjust.png" height="35" style="cursor:pointer" onClick="javascript:chkForm('Y');return false;" />
                      ...
                      <!-- <img src="<?php echo $misc; ?>img/btn_continue.png" id="continueBtn" height="35" style="cursor:pointer;display:none" onClick="formAction1();" /> -->
                      <img src="<?php echo $misc; ?>img/dashboard/btn/btn_cancel.png" height="35" style="cursor:pointer" onClick="javascript:history.go(-1)" /></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  </tr>

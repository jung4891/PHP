...
<body>
  ...
  document.mform.action = "<?php echo site_url();?>/tech/board/faq_list";
  ...
  ?>
		<form name="mform" action="<?php echo site_url();?>/tech/board/faq_list" method="get" onkeydown="if(event.keyCode==13) return GoSearch();">
     ...
     <div class="menu_div">
   		<a class="menu_list" onclick ="moveList('manual_list')" style='color:#B0B0B0'>자료실</a>
   		<a class="menu_list" style='color:#0575E6'>FAQ</a>
   	</div>
...
<?php } ?>
  ...
  function ViewBoard (seq){
  	document.mform.action = "<?php echo site_url();?>/tech/board/faq_view";

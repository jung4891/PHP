  ...
  function chkForm( type ) {
   if(type == 1) {
    if (confirm("등록된 모든 코멘트들도 삭제됩니다. 정말 삭제하시겠습니까?") == true){
     ...
     mform.action="<?php echo site_url();?>/tech/board/eduevent_delete_action";
     mform.submit();
     return false;
   }
 } else {
  var mform = document.cform;
  mform.action="<?php echo site_url();?>/tech/board/eduevent_view";
  mform.submit();
  return false;
}
}
...
function chkForm2() {
	...
	rform.action="<?php echo site_url();?>/tech/board/eduevent_comment_action";
	rform.submit();
	return false;
}
...
function chkForm3(seq) {
	if (confirm("정말 삭제하시겠습니까?") == true){
		...
		rform.action="<?php echo site_url();?>/tech/board/eduevent_comment_delete";
		rform.submit();
		return false;
	}
}
    ...
    <td align="center" valign="top">
     ...
     <td width="923" align="center" valign="top">
      ...
      <table width="1100" border="0" style="margin-top:50px; margin-bottom: 50px;">
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed; word-break:break-all;">
            ...
            <tr>
              ...
              <td class="t_border" style="padding-left:10px;" colspan="3"><?php if($view_val['file_changename']) {?><a href="<?php echo site_url();?>/tech/board/eduevent_download/<?php echo $seq;?>/<?php echo $view_val['file_changename'];?>"><?php echo $view_val['file_realname'];?></a><?php } else {?>파일없음<?php }?> </td>
            </tr>
            <tr>
              <tr>
                <td colspan="4" height="2" bgcolor="#797c88"></td>
        ...
        <tr>
          <td align="right"><img src="<?php echo $misc;?>img/btn_list.jpg" border="0" style="cursor:pointer" onClick="javascript:history.go(-1);"/> <?php if($id == $view_val['user_id'] || $tech_lv == 3) {?><img src="<?php echo $misc;?>img/btn_adjust.jpg" style="cursor:pointer" border="0" onClick="javascript:chkForm(0);return false;"/> <img src="<?php echo $misc;?>img/btn_delete.jpg" style="cursor:pointer" border="0" onClick="javascript:chkForm(1);return false;"/><?php }?></td>
        </tr>
        <tr>
          <td></td>
        </tr>
              ...
              <tr>
                <td bgcolor="f8f8f9"><table width="185" border="0" cellspacing="0" cellpadding="5">
                  <tr>
                    ...
                    <td width="10%" align="right"><?php if($id == $item['user_id'] or $tech_lv == 3) {?><img src="<?php echo $misc;?>img/btn_del.jpg" width="18" height="17" style="cursor:pointer" border="0" onClick="javascript:chkForm3('<?php echo $item['seq']?>');return false;"/><?php }?></td>
                  </tr>
                </table></td>
              </tr>
              <tr>

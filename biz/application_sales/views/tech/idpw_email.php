...
<body>
	<div class="warp">
    	<!--상단-->
        <div class="idpw_top"><img src="<?php echo $misc;?>img/email_form_top1.jpg" /></div>
        <!--//상단-->
        <!--타이틀-->
        <div class="idpw_title"><img src="<?php echo $misc;?>img/email_form_title.jpg" /></div>
        <!--//상단-->
        ...
        <!--버튼(로그인바로가기)-->
        <div class="email_btn"><a href="<?php echo site_url();?>/account" title="로그인페이지로이동" target="_blank"><img src="<?php echo $misc;?>img/btn_email.jpg" /></a></div>
        <!--//버튼(로그인바로가기)-->
        
        <!--하단-->
        <div class="idpw_footer"><img src="<?php echo $misc;?>img/email_form_footer.jpg" /></div>
        <!--//하단-->
</div>
</body>
</html>

...
<script>
    ...
    function durian_sign() {
        alert("엔지니어 서명이 들어갈 위치를 클릭해 주세요.");
        document.onmousedown = function(){
            if (event.button == 0) {
                ...
                img.src = "<?php echo $misc; ?>img/임선영.png" // 이미지 경로 설정 (랜덤)
                ...
                img.onmousedown = function () {
                    if (event.button == "2") {
						...
						opener.document.cform.durian_coordinate.value = img.style.top+","+img.style.left;
						alert("저장되었습니다.");
						self.close();
                        return false;
                    }

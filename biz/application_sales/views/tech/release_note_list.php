...
document.mform.action = "<?php echo site_url();?>/tech/board/release_note_list";
...
<body>
  ...
  <div align="center">
  <div class="dash1-1">
  <form name="mform" action="<?php echo site_url();?>/tech/board/release_note_list" method="get" onKeyDown="if(event.keyCode==13) return GoSearch();">
<table width="95%" height="100%" border="0" cellspacing="0" cellpadding="0" class="dash_tbl1-1">
    ...
    ?>
            ...
            <td align="right">
              <a href="<?php echo site_url();?>/tech/board/release_note_input">
                ...
                if ($count > 0) {
                  ...
                  foreach ( $list_val as $item ) {
                    ...
                    <tr onMouseOver="this.style.backgroundColor='#FAFAFA'" onMouseOut="this.style.backgroundColor='#fff'">
                      ...
                      <td align="center"><a href="JavaScript:ViewBoard('<?php echo $item['seq'];?>')"><?php echo $this->common->trim_text(stripslashes($item['subject']), 100);?></a><?php if($item['cnum'] > 0) { ?><span class="point2">(<?php echo $item['cnum'];?>)</span><?php } ?></td>
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/tech/board/release_note_view";

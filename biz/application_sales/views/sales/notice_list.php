...
//	}
	...
	document.mform.action = "<?php echo site_url();?>/sales/board/notice_list";
...
<form name="mform" action="<?php echo site_url();?>/sales/board/notice_list" method="get" onKeyDown="if(event.keyCode==13) return GoSearch();">
  ...
  <tr>
    ...
    <table width="1130" height="100%" cellspacing="0" cellpadding="0" >
        <tr>
            ...
            <table width="1100" border="0" style="margin-top:50px;">
              <tr>
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/sales/board/notice_view";
	...
	document.mform.submit();
			 ...
			 <?php if($sales_lv == 3) {?>
              ...
              <tr>
                <td align="right"><a href="<?php echo site_url();?>/sales/board/notice_input"><img src="<?php echo $misc;?>img/btn_write.jpg" width="64" height="31" /></td>
              </tr>
			  <?php }?>
              <tr>
                <td height="10"></td>

			 ...
			 <!--탭-->
              <tr>
              	<td height="40">
                    ...
                    <li style="float:left;"><a href="<?php echo site_url();?>/sales/customer/customer_view3/<?php echo $seq;?>"><img src="<?php echo $misc;?>img/sales_tab_3_on.jpg" /></a></li>
              ...
              <tr>
				...
				<form name="mform" action="<?php echo site_url();?>/sales/customer/customer_view3/<?php echo $seq;?>" method="get">
				...
				<input type="hidden" name="seq" value="">
                  ...
                  <tr>
                    <td height="40" align="center" bgcolor="f8f8f9" style="font-weight:bold;" ></td>
				...
				if ($count > 0) {
					...
					foreach ( $list_val as $item ) {
						...
						if($item['file_changename']) {
							$strFile = "<a href='".site_url()."/sales/customer/customer_download4/".$item['seq']."/".$item['file_changename']."'>".$item['file_realname']."</a>";
						} else {
							$strFile = "-";
						}

						$strVal = explode(",", $view_val['sourcing_code']);
						if (in_array($item['seq'], $strVal)) {
				?>
...
//}
              ...
              <tr>
				...
				<form name="cform" action="<?php echo site_url();?>/sales/customer/customer_input_action3" method="post" enctype="multipart/form-data" onSubmit="javascript:chkForm();return false;">
				...
				<input type="hidden" name="mode" value="1">
                  ...
                  <tr>
                    ...
                    <input name="awards_experience" type="radio" value="001" style=" float:left;" <?php if($view_val['awards_experience'] == "001") { echo "checked"; }?>/> <span style=" display:block; float:left; line-height:18px; padding:0 5px;">장관이상</span> 
                    <input name="awards_experience" type="radio" value="002" style="float:left;" <?php if($view_val['awards_experience'] == "002") { echo "checked"; }?>/> <span style=" display:block; float:left; line-height:18px; padding:0 5px;">협회장이상</span>
                    <input name="awards_experience" type="radio" value="003" style="float:left;" <?php if($view_val['awards_experience'] == "003") { echo "checked"; }?>/> <span style=" display:block; float:left; line-height:18px; padding:0 5px;">없음</span>
                    </td>
                    <td height="40" align="center" bgcolor="f8f8f9" class="t_border" style="font-weight:bold;">품질인증여부</td>
                    <td align="left" class="t_border" style="padding-left:10px;">
                    <input name="quality_flag" type="radio" value="Y" style=" float:left;" <?php if($view_val['quality_flag'] == "Y") { echo "checked"; }?>/> <span style=" display:block; float:left; line-height:18px; padding:0 5px;">Yes</span> 
                    <input name="quality_flag" type="radio" value="N" style="float:left;" <?php if($view_val['quality_flag'] == "N") { echo "checked"; }?>/> <span style=" display:block; float:left; line-height:18px; padding:0 5px;">No</span>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;"><input name="major_awards" type="text" class="input2" id="major_awards" value="<?php echo $view_val['major_awards'];?>"/></td>
                    <td height="40" align="center" bgcolor="f8f8f9" class="t_border" style="font-weight:bold;">품질인증명</td>
                    <td align="left" class="t_border" style="padding-left:10px;"><input name="quality_certification" type="text" class="input2" id="quality_certification" value="<?php echo $view_val['quality_certification'];?>"/></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;"><?php if($view_val['file_changename']) {?><a href="<?php echo site_url();?>/sales/customer/customer_download3/<?php echo $seq;?>/<?php echo $view_val['file_changename'];?>"><?php echo $view_val['file_realname'];?></a><?php } else {?>파일없음<?php }?> </td>
                  </tr>  
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;"><input name="awards_count" type="text" class="input0" id="awards_count" value="<?php echo $view_val['awards_count'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);"/> <span style="color:#333; font-size:12px;">회</span></td>
                  </tr>  

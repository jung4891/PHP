...
<body>
  ...
  ?>
		<form name="mform" action="<?php echo site_url();?>/sales/forcasting/order_completed_list" method="get">
			...
			<div class="menu_div">
			 <a class="menu_list" onclick ="moveList('order_completed_list')" style='color:#0575E6'>수주완료</a>
			 <a class="menu_list" onclick ="moveList('forcasting_list?mode=mistake')" style='color:#B0B0B0'>실주</a>
			</div>
    ...
    <div class="modal_contain" style="font-size:16px; color:#1C1C1C;font-weight:bold;">
      <table style="width:100%;padding:5%;" cellspacing="0">
      		...
      		<td align="left" colspan="2" height="40">매출금액</td>
				...
				<tr>
					<td>
						<input type="text" id="filter2_4" class="input-common filtercolumn2" style="text-align:right;width:100%;margin-right:0" onchange="numberFormat(this)" value='<?php if(isset($filter)&&$search_mode=='simple'){if($filter[3]!=""){echo number_format($filter[3]);}} ?>' placeholder="원"/>
					</td>
					<td>
						<input type="text" id="filter2_5" class="input-common filtercolumn2" style="text-align:right;width:100%;margin-right:0" onchange="numberFormat(this)" value='<?php if(isset($filter)&&$search_mode=='simple'){if($filter[4]!=""){echo number_format($filter[4]);}} ?>' placeholder="원"/>
					</td>
				</tr>
				<tr>
					<td height="20"></td>
				...
				<tr>
					<td colspan="2">
						<input type="text" id="filter2_6" class="input-common filtercolumn2" value="<?php if(isset($filter)&&$search_mode=='simple'){echo $filter[5];} ?>" style="width:100%;" placeholder="검색하세요.">
					</td>
				</tr>
				<tr>
          <td height="20"></td>

...
//	}
	...
	document.mform.action = "<?php echo site_url();?>/sales/board/manual_list";
...
<div align="center">
<div class="dash1-1">
<form name="mform" action="<?php echo site_url();?>/sales/board/manual_list" method="get" onKeyDown="if(event.keyCode==13) return GoSearch();">
...
?>
        ...
        <span>
			  ...
			  <td align="right">
					<a href="<?php echo site_url();?>/sales/board/manual_input">
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/sales/board/manual_view";

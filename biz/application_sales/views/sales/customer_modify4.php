...
$(function() {
	$("#service_add").click(function() {
		...
		$('#service_insert_field_2_1').after("<tr id=" + id + "><td colspan='9' height='1' bgcolor='#e8e8e8'></td></tr><tr id=" + id2 + "><td height='40' align='center'><input name='service_supply' type='text' class='input2' id='service_supply' /></td><td align='center' class='t_border' ><input name='expert_work' type='text' class='input2' id='expert_work' /></td><td align='center' class='t_border' ><img src='<?php echo $misc;?>img/btn_del0.jpg' style='cursor:pointer;' onclick='javascript:service_list_del(" + $("#row_max_index").val() + ");'/></td></tr>");
	});
	...
	$("#project_add").click(function() {
		...
		$('#project_insert_field_2_1').after("<tr id=" + id + "><td colspan='9' height='1' bgcolor='#e8e8e8'></td></tr><tr id=" + id2 + "><td height='40' align='center'><input name='project_name' type='text' class='input' id='project_name' /></td><td align='center' class='t_border' ><input name='perform_company' type='text' class='input1' id='perform_company' /></td><td align='center' class='t_border' ><input name='start_date' type='text' class='input1' id='start_date' onclick='checkNum(this);' onKeyUp='checkNum(this);'/></td><td align='center' class='t_border' ><input name='end_date' type='text' class='input1' id='end_date' onclick='checkNum(this);' onKeyUp='checkNum(this);'/></td><td align='center' class='t_border' ><input name='main_role' type='text' class='input' id='main_role' /></td><td align='center' class='t_border' ><input name='main_service' type='text' class='input' id='main_service' /></td><td align='center' class='t_border' ><input name='expertise' type='text' class='input1' id='expertise' /></td><td align='center' class='t_border' ><input name='solution' type='text' class='input1' id='solution' /></td><td align='center' class='t_border' ><img src='<?php echo $misc;?>img/btn_del0.jpg' style='cursor:pointer;' onclick='javascript:project_list_del(" + $("#row_max_index2").val() + ");'/></td></tr>");
	});
});
...
<form name="cform" action="<?php echo site_url();?>/sales/customer/customer_input_action4" method="post" onSubmit="javascript:chkForm();return false;">
  ...
  <tr>
    ...
    <table width="1130" height="100%" cellspacing="0" cellpadding="0" >
        <tr>
            ...
            <table width="1100" border="0" style="margin-top:50px; margin-bottom: 50px;">
             ...
             <tr>
              	<td height="40">
                    ...
                    <li style="float:left;"><a href="<?php echo site_url();?>/sales/customer/customer_view2/<?php echo $seq;?>"><img src="<?php echo $misc;?>img/sales_tab_2.jpg" /></a></li>
                    ...
                    <li style="float:left;"><a href="<?php echo site_url();?>/sales/customer/customer_view4/<?php echo $seq;?>"><img src="<?php echo $misc;?>img/sales_tab_4_on.jpg" /></a></li>
			...
			?>
                  <!--추가항목-->
                  <tr id="service_insert_field_<?php echo $i;?>">
                    <td colspan="9" height="1" bgcolor="#e8e8e8"></td>
                  </tr>
                  <tr id="service_insert_field_2_<?php echo $i;?>">
                    <td height="40" align="center"><input name="service_supply" type="text" class="input2" id="service_supply" value="<?php echo $item['service_supply'];?>"/></td>
                    <td align="center" class="t_border" ><input name="expert_work" type="text" class="input2" id="expert_work" value="<?php echo $item['expert_work'];?>"/></td>
			...
			?>
                  ...
                  <tr id="service_insert_field_2_<?php echo $i;?>">
                    <td height="40" align="center"><input name="service_supply" type="text" class="input2" id="service_supply" value="<?php echo $item['service_supply'];?>"/></td>
                    <td align="center" class="t_border" ><input name="expert_work" type="text" class="input2" id="expert_work" value="<?php echo $item['expert_work'];?>"/></td>
                    <td align="center" class="t_border" ><!-- <img src="<?php echo $misc;?>img/btn_del0.jpg" onclick='javascript:service_list_del(<?php echo $i;?>);' style="cursor:pointer;"/> --></td>
                  </tr>
                  <!--//추가항목-->
			<?php
					}
			...
			?>
                  <!--추가항목-->
                  <tr id="project_insert_field_<?php echo $j;?>">
                    <td colspan="9" height="1" bgcolor="#e8e8e8"></td>
                  </tr>
                  <tr id="project_insert_field_2_<?php echo $j;?>">
                    <td height="40" align="center"><input name="project_name" type="text" class="input" id="project_name" value="<?php echo $item2['project_name'];?>"/></td>
                    <td align="center" class="t_border" ><input name="perform_company" type="text" class="input1" id="perform_company" value="<?php echo $item2['perform_company'];?>"/></td>
                    <td align="center" class="t_border" ><input name="start_date" type="text" class="input1" id="start_date" value="<?php echo $item2['start_date'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);"/></td>
                    <td align="center" class="t_border" ><input name="end_date" type="text" class="input1" id="end_date" value="<?php echo $item2['end_date'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);"/></td>
                    <td align="center" class="t_border" ><input name="main_role" type="text" class="input" id="main_role" value="<?php echo $item2['main_role'];?>"/></td>
                    <td align="center" class="t_border" ><input name="main_service" type="text" class="input" id="main_service" value="<?php echo $item2['main_service'];?>"/></td>
                    <td align="center" class="t_border" ><input name="expertise" type="text" class="input1" id="expertise" value="<?php echo $item2['expertise'];?>"/></td>
                    <td align="center" class="t_border" ><input name="solution" type="text" class="input1" id="solution" value="<?php echo $item2['solution'];?>"/></td>
                    <td align="center" class="t_border" ><!-- <img src="<?php echo $misc;?>img/btn_del0.jpg" /> --></td>
                  </tr>
                  <!--//추가항목-->
			<?php
			...
			?>
                  ...
                  <tr id="project_insert_field_2_<?php echo $j;?>">
                    ...
                    <td align="center" class="t_border" ><input name="expertise" type="text" class="input1" id="expertise" value="<?php echo $item2['expertise'];?>"/></td>
                    <td align="center" class="t_border" ><input name="solution" type="text" class="input1" id="solution" value="<?php echo $item2['solution'];?>"/></td>
                    <td align="center" class="t_border" ><!-- <img src="<?php echo $misc;?>img/btn_del0.jpg" onclick='javascript:project_list_del(<?php echo $j;?>);' style="cursor:pointer;"/> --></td>
                  </tr>
			<?php
					}
					$max_number2 = $j;
              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;" ><input name="homepage" type="text" class="input2" id="homepage" value="<?php echo $view_val3['homepage'];?>"/> <span style="color:#666; font-size:12px;">예) http://www.durianit.co.kr</span></td>
                  </tr>

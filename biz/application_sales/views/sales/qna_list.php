...
//	}
	...
	document.mform.action = "<?php echo site_url();?>/sales/board/qna_list";
...
<form name="mform" action="<?php echo site_url();?>/sales/board/qna_list" method="get" onKeyDown="if(event.keyCode==13) return GoSearch();">
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/sales/board/qna_view";
	...
	document.mform.submit();
             ...
             <!---------------------------------- 글쓰기 버튼넣기------------------------------>
              ...
              <tr>
                <td align="right"><a href="<?php echo site_url();?>/sales/board/qna_input"><img src="<?php echo $misc;?>img/btn_write.jpg" width="64" height="31" /></td>
              </tr>
              <tr>
                <td height="10"></td>
              </tr>

...
function chkForm () {
	...
	if (mform.company_category.value == "") {
		mform.company_category.focus();
		alert("업태를 입력해 주세요.");
		return false;
	}
	if (mform.company_sector.value == "") {
		mform.company_sector.focus();
		alert("업종을 입력해 주세요.");
		return false;
	}
	if (mform.establish_date.value == "") {
		mform.establish_date.focus();
		alert("설립일자를 선택해 주세요.");
		return false;
	}
	...
	if (mform.represent_handphone.value == "") {
		mform.represent_handphone.focus();
		alert("대표자 이동전화를 입력해 주세요.");
		return false;
	}
	...
	if (mform.represent_email.value == "") {
		mform.represent_email.focus();
		alert("대표 이메일을 입력해 주세요.");
		return false;
	}
	var regex2=/^([\w-]+(?:\.[\w-]+)*)@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$/;
	if(regex2.test(mform.represent_email.value) === false) {  
		alert("잘못된 이메일 형식입니다.");
		mform.represent_email.focus();
		return false;  
	}
	if (mform.university.value == "") {
		mform.university.focus();
		alert("출신대학교를 입력해 주세요.");
		return false;
	}
	if (mform.bnum.value == "") {
		mform.bnum.focus();
	...
	if (mform.deposit_name.value == "") {
		mform.deposit_name.focus();
		alert("예금주를 입력해 주세요.");
		return false;
	}
...
function openDaumPostcode() {
	new daum.Postcode({
		oncomplete: function(data) {
			...
			document.getElementById('company_post').value = data.postcode1 + data.postcode2;
...
function openDaumPostcode2() {
	new daum.Postcode({
		oncomplete: function(data) {
			// 팝업에서 검색결과 항목을 클릭했을때 실행할 코드를 작성하는 부분.
			// 우편번호와 주소 정보를 해당 필드에 넣고, 커서를 상세주소 필드로 이동한다.
			document.getElementById('post_post').value = data.postcode1 + data.postcode2;
...
<form name="cform" action="<?php echo site_url();?>/sales/customer/customer_input_action" method="post" enctype="multipart/form-data" onSubmit="javascript:chkForm();return false;">
			 ...
			 <!--탭-->
              <tr>
              	<td height="40">
                    ...
                    <li style="float:left;"><a href="<?php echo site_url();?>/sales/customer/customer_view"><img src="<?php echo $misc;?>img/sales_tab_1_on.jpg" /></a></li>
              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;"><input name="rnum" type="text" class="input2" id="rnum" value="<?php echo $view_val['company_name'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);"/></td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td align="left" class="t_border" style="padding-left:10px;"><input name="cnum" type="text" class="input" id="cnum" value="<?php echo $view_val['cnum'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);"/> <?php if($view_val['cnumfile_changename']) {?><a href="<?php echo site_url();?>/sales/customer/customer_download/<?php echo $seq;?>/<?php echo $view_val['cnumfile_changename'];?>"><?php echo $view_val['cnumfile_realname'];?></a><?php } else {?>파일없음<?php }?></td>
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;"><input name="establish_date" type="text" class="input" id="establish_date" style="float:left;" value="<?php echo $view_val['establish_date'];?>" readonly/> <!-- <img src="<?php echo $misc;?>img/btn_calendar.jpg" /> --></td>
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;"><input name="represent_tel" type="text" class="input" id="represent_tel" value="<?php echo $view_val['represent_tel'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);"/> <span style="color:#999; font-size:10px;">예) 02-000-0000</span></td>
                  </tr> 
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;"><input name="represent_handphone" type="text" class="input" id="represent_handphone" value="<?php echo $view_val['represent_handphone'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);"/> <span style="color:#999; font-size:10px;">예) 010-0000-0000</span></td>
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;"><input name="birth_date" type="text" class="input" id="birth_date" style="float:left;" value="<?php echo $view_val['birth_date'];?>" readonly/><!-- <img src="<?php echo $misc;?>img/btn_calendar.jpg" /> --></td>
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;"><input name="bnum" type="text" class="input" id="bnum" value="<?php echo $view_val['bnum'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);"/> <?php if($view_val['bnumfile_changename']) {?><a href="<?php echo site_url();?>/sales/customer/customer_download2/<?php echo $seq;?>/<?php echo $view_val['bnumfile_changename'];?>"><?php echo $view_val['bnumfile_realname'];?></a><?php } else {?>파일없음<?php }?></td>

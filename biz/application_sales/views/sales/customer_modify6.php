...
<form name="cform" action="<?php echo site_url();?>/sales/customer/customer_input_action6" method="post" enctype="multipart/form-data" onSubmit="javascript:chkForm();return false;">
			 ...
			 <!--탭-->
              <tr>
              	<td height="40">
                    ...
                    <li style="float:left;"><a href="<?php echo site_url();?>/sales/customer/customer_view6/<?php echo $seq;?>"><img src="<?php echo $misc;?>img/sales_tab_6_on.jpg" /></a></li>
                    </ul>
                </td>
              </tr>
              <!--//탭-->
              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;"><span style="color:#333; font-size:14px;"><input name="rate" type="text" class="input" id="rate" value="<?php echo $view_val['rate'];?>"/></span>&nbsp;&nbsp;&nbsp;&nbsp;<?php if($view_val['file_changename']) {?><a href="<?php echo site_url();?>/sales/customer/customer_download10/<?php echo $seq;?>/<?php echo $view_val['file_changename'];?>"><?php echo $view_val['file_realname'];?></a><?php } ?></td>
                  </tr>

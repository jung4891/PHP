...
//	}
	...
	document.mform.action = "<?php echo site_url();?>/sales/board/edudata_list";
...
<form name="mform" action="<?php echo site_url();?>/sales/board/edudata_list" method="get" onKeyDown="if(event.keyCode==13) return GoSearch();">
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/sales/board/edudata_view";
	...
	document.mform.submit();
			 ...
			 <?php if($sales_lv == 3) {?>
              ...
              <tr>
                <td align="right"><a href="<?php echo site_url();?>/sales/board/edudata_input"><img src="<?php echo $misc;?>img/btn_write.jpg" width="64" height="31" /></td>
              </tr>
			  <?php }?>
              <tr>
                <td height="10"></td>

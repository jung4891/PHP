...
function filedel(seq, filename) {
	if (confirm("정말 삭제하시겠습니까?") == true){
		location.href = "<?php echo site_url();?>/sales/customer/customer_filedel/" + seq + "/" + filename;
		return false;
	}
}
function filedel2(seq, filename) {
	if (confirm("정말 삭제하시겠습니까?") == true){
		location.href = "<?php echo site_url();?>/sales/customer/customer_filedel2/" + seq + "/" + filename;
		return false;
	}
}
function filedel3(seq, filename) {
	if (confirm("정말 삭제하시겠습니까?") == true){
		location.href = "<?php echo site_url();?>/sales/customer/customer_filedel3/" + seq + "/" + filename;
		return false;
	}
}
function filedel4(seq, filename) {
	if (confirm("정말 삭제하시겠습니까?") == true){
		location.href = "<?php echo site_url();?>/sales/customer/customer_filedel4/" + seq + "/" + filename;
		return false;
	}
}
function filedel5(seq, filename) {
	if (confirm("정말 삭제하시겠습니까?") == true){
		location.href = "<?php echo site_url();?>/sales/customer/customer_filedel5/" + seq + "/" + filename;
		return false;
	}
}
...
<form name="cform" action="<?php echo site_url();?>/sales/customer/customer_input_action5" method="post" enctype="multipart/form-data" onSubmit="javascript:chkForm();return false;">
			 ...
			 <!--탭-->
              <tr>
              	<td height="40">
                    ...
                    <li style="float:left;"><a href="<?php echo site_url();?>/sales/customer/customer_view5/<?php echo $seq;?>"><img src="<?php echo $misc;?>img/sales_tab_5_on.jpg" /></a></li>
              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;"><?php if($view_val['bfile_changename']) {?><a href="<?php echo site_url();?>/sales/customer/customer_download5/<?php echo $seq;?>/<?php echo $view_val['bfile_changename'];?>"><?php echo $view_val['bfile_realname'];?></a><?php }?></td>
                  </tr>
              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                  	<td height="40" align="center" bgcolor="f8f8f9" style="font-weight:bold;">전기재무정보 파일</td>
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;"><?php if($view_val['bfile_changename2']) {?><a href="<?php echo site_url();?>/sales/customer/customer_download6/<?php echo $seq;?>/<?php echo $view_val['bfile_changename2'];?>"><?php echo $view_val['bfile_realname2'];?></a><?php }?></td>
                  </tr>
              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;"><?php if($view_val['dfile_changename']) {?><a href="<?php echo site_url();?>/sales/customer/customer_download7/<?php echo $seq;?>/<?php echo $view_val['dfile_changename'];?>"><?php echo $view_val['dfile_realname'];?></a><?php } ?></td>
                  </tr>
              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;"><?php if($view_val['cfile_changename']) {?><a href="<?php echo site_url();?>/sales/customer/customer_download8/<?php echo $seq;?>/<?php echo $view_val['cfile_changename'];?>"><?php echo $view_val['cfile_realname'];?></a><?php } ?></td>
                  </tr>
              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td height="40" class="t_border" align="center" bgcolor="f8f8f9" style="font-weight:bold;">*납세증명서파일</td>
                    <td align="left" class="t_border" style="padding-left:10px;"><?php if($view_val['gfile_changename']) {?><a href="<?php echo site_url();?>/sales/customer/customer_download9/<?php echo $seq;?>/<?php echo $view_val['gfile_changename'];?>"><?php echo $view_val['gfile_realname'];?></a><?php } ?></td>
                  </tr>

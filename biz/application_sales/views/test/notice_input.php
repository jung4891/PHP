...
<form name="cform" action="<?php echo site_url();?>/test/board/notice_input_action" method="post" enctype="multipart/form-data" onSubmit="javascript:chkForm();return false;">
  <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
					...
					CKEDITOR.replace( 'contents', {
						filebrowserUploadUrl: '<?php echo site_url();?>/test/board/notice_input_action_image'
					});
					</script></td>
                  </tr><tr>
                    <td colspan="4" height="1" bgcolor="#797c88"></td>

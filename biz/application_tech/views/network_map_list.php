...
document.mform.action = "<?php echo site_url();?>/board/network_map_list";
...
<body>
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
    <form name="mform" action="<?php echo site_url();?>/board/network_map_list" method="get" onkeydown="if(event.keyCode==13) return GoSearch();">
          ...
          <td><table border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td>
                ...
                <option value="002" <?php if($search1 == "002"){ echo "selected";}?>>제목</option>
                <option value="003" <?php if($search1 == "003"){ echo "selected";}?>>등록자</option>
              </select>
            </td>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><input  type="text" size="50" class="input" name="searchkeyword" placeholder="검색하세요." value="<?php echo str_replace('"', '&uml;', $search_keyword );?>"/></td>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr bgcolor="f8f8f9" class="t_top">
            ...
            <td width="20%" align="center" class="t_border">고객사</td>
            <td width="40%" align="center" class="t_border">제목</td>
          ...
          if ($count > 0) {
           ...
           <tr onmouseover="this.style.backgroundColor='#FAFAFA'" onmouseout="this.style.backgroundColor='#fff'">
            ...
            <td width="20%" height="40" align="center"><a href="JavaScript:ViewBoard('<?php echo $item['seq'];?>')"><?php echo $item['category_code']?></a></td>
            <td width="40%" class="t_border" style="padding-left:10px;"><a href="JavaScript:ViewBoard('<?php echo $item['seq'];?>')"><?php echo $this->common->trim_text(stripslashes($item['subject']), 100);?></a></td>
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/board/network_map_view";
...
<tr>
  <td align="right"><a href="<?php echo site_url();?>/board/network_map_input"><img src="<?php echo $misc;?>img/btn_write.jpg" width="64" height="31" /></td>
</tr>
<?php }?>
<tr>
  <td height="10"></td>

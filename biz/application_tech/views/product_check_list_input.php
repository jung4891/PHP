...
<input type="hidden" name="work_text" id="work_text" value="" />
<div style="margin:10px 0 10px 0 ;"><span class="title">제품명</span><input type="text" name="product_name" id="product_name" class="input2" ></div>
<table id="work_text_table1" class="work_text_table" width=100% border=1 style="border-collapse:collapse;border-right:none;border-left:none;">
  <tr>
    ...
    <th colspan="2" height="30" bgcolor="f8f8f9"><input value="점검내용" readonly onfocus="javascrpt:blur();"
        style="cursor:default; font-weight:bold; text-align: -webkit-center; background-color:transparent;"></input>
    </th>
...
<script>
  ...
  function chkForm(){
    ...
    document.forms['cform'].action="<?php echo site_url(); ?>/tech_board/product_check_list_input_action";

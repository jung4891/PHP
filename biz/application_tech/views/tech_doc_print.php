...
function tech_doc_pdf_mail(){
	window.open("<?php echo site_url();?>/tech_board/tech_doc_pdf_send_mail?seq=<?php echo $view_val['seq']; ?>");
}
...
$(document).ready(function () {
  ...
  function printPage(){
    window.open("<?php echo site_url();?>/tech_board/tech_doc_print_page?seq=<?php echo base64_encode($view_val['seq'] ); ?>", "cform", 'scrollbars=yes,width=850,height=600'); 
  }

...
document.mform.action = "<?php echo site_url();?>/board/faq_list";
...
<body>
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
    <form name="mform" action="<?php echo site_url();?>/board/faq_list" method="get" onkeydown="if(event.keyCode==13) return GoSearch();">
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/board/faq_view";
...
<tr>
  <td align="right"><a href="<?php echo site_url();?>/board/faq_input"><img src="<?php echo $misc;?>img/btn_write.jpg" width="64" height="31" /></td>
</tr>
<?php }?>
<tr>
  <td height="10"></td>

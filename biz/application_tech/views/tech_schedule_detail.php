  ...
  <div id="sd_contain">
    ...
    <div id='calendar'>
      <li style="list-style-type : none; text-align: right; font-size:15px; font-wieght:bold; text-decoration : underline;">
        <a href="<?php echo site_url();?>/schedule/tech_schedule">돌아가기</a>
      </li>
...
?>
              ...
              <tr>
                ...
                <td >
                  <div class="dropdown" id="dropdown">
                    ...
                    <input id="customerName" name ="customerName" type="text" class="customerName" value="<?php echo $details->customer;?>" style="border:none;width:200px;font-weight:bold;text-align:center;" onchange="customerNameChange(this.value);" readonly>
              ...
              <tr>
                <td>프로젝트명</td>
                <td>
                  <input type="text" id="project" name="project" value="<?php echo $details->project;?>" size='45'>
                <td>
              </tr>
              <!-- KI2 20210125 -->
              <tr>
      ...
      // }else if((regParticipant.indexOf(session_name) > -1)){ //indexOf값이 -1이 아니면 regParticipant 안에 본인이 들어가 있다는 것, 기지보 작성 가능하게 보인다.
      //   $("#updateSchedule").find("input, select, button, textarea").not("input.techReportSubmit").prop("disabled", true);
      // }else{ //
      //   $("#updateSchedule").find("input, select, button, textarea").prop("disabled", true);
      // }
      //KI2 20210125
      ...
      function modify(mode){
        if(mode == 'report'){
          ...
          //KI2 20210125
          var act = "<?php echo site_url();?>/tech_board/tech_doc_input";
          ...
          $.ajax({
            type: "POST",
            url:"/index.php/schedule/tech_seq_find",
            dataType:"json",
            data:{
            ...
            success: function(data) {
              ...
              $('#mode').val('view');
              $('#link').val('sch_modify');
              var act = "<?php echo site_url();?>/tech_board/tech_doc_view";
          ...
          var act = "<?php echo site_url();?>/schedule/modify"
          $("#hiddenSeq").attr('action', act).submit();
        }
      }

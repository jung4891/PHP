...
function filedel(seq, filename) {
	if (confirm("정말 삭제하시겠습니까?") == true){
		location.href = "<?php echo site_url();?>/board/release_note_filedel/" + seq + "/" + filename;
		return false;
	}
}
...
<form name="cform" action="<?php echo site_url();?>/board/release_note_input_action" method="post" enctype="multipart/form-data" onSubmit="javascript:chkForm();return false;">
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
					...
					CKEDITOR.replace( 'contents', {
						filebrowserUploadUrl: '<?php echo site_url();?>/board/release_note_input_action_image'
					});
					</script></td>
                  </tr><tr>
                    <td colspan="4" height="1" bgcolor="#797c88"></td>
                  ...
                  <tr>
                    ...
                    <td class="t_border" style="padding-left:10px;" colspan="3"><?php if($view_val['file_changename']) {?><a href="<?php echo site_url();?>/board/release_note_download/<?php echo $seq;?>/<?php echo $view_val['file_changename'];?>"><?php echo $view_val['file_realname'];?></a> <a href="javascript:filedel('<?php echo $seq;?>','<?php echo $view_val['file_changename'];?>');"><img src="<?php echo $misc;?>img/del.png" width="8" height="8" /></a>&nbsp;&nbsp;<input name="cfile" id="cfile" type="file" size="78" disabled><?php } else {?><input name="cfile" type="file" size="78"> <span class="point0 txt_s">(용량제한 100MB)<?php }?> </td>
                  </tr>
                  <tr>
                  <tr>
                    <td colspan="4" height="2" bgcolor="#797c88"></td>

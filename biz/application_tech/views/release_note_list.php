...
document.mform.action = "<?php echo site_url();?>/board/release_note_list";
...
<body>
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
    <form name="mform" action="<?php echo site_url();?>/board/release_note_list" method="get" onKeyDown="if(event.keyCode==13) return GoSearch();">
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/board/release_note_view";
...
<tr>
  <td align="right"><a href="<?php echo site_url();?>/board/release_note_input"><img src="<?php echo $misc;?>img/btn_write.jpg" width="64" height="31" /></td>
</tr>
<tr>
  <td height="10"></td>
</tr>

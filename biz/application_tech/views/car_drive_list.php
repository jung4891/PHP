...
//  }
  ...
  document.mform.action = "<?php echo site_url();?>/durian_car/car_drive_list";
...
<form name="mform" action="<?php echo site_url();?>/durian_car/car_drive_list" method="get" onKeyDown="if(event.keyCode==13) return GoSearch();">
    ...
    <table width="1130" height="100%" cellspacing="0" cellpadding="0" >
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr bgcolor="f8f8f9" class="t_top">
                    ...
                    <td width="15%" align="center" class="t_border">차종</td>
                    <td width="15%" align="center" class="t_border">출발지</td>
                    <td width="15%" align="center" class="t_border">목적지</td>
                    <td width="10%" align="center" class="t_border">출발시km</td>
                    <td width="10%" align="center" class="t_border">도착시km</td>
                    <td width="8%" align="center" class="t_border">주행거리</td>
                    <td width="10%" align="center" class="t_border">운행자</td>
                    <td width="12%" align="center" class="t_border">운행일</td>
                  </tr>
                  <tr>
      ...
      ?>
                  <tr onMouseOver="this.style.backgroundColor='#EAEAEA'" onMouseOut="this.style.backgroundColor='#fff'">
                    ...
                    <td width="8%" align="center" class="t_border">
                        <?php echo $item['a_km']-$item['d_km'];?>km
                    </td>
                    <td width="10%" align="center" class="t_border">
                        <?php echo $item['driver'];?>
                    </td>
                    <td width="12%" align="center" class="t_border">
...
function ViewBoard (seq){
  document.mform.action = "<?php echo site_url();?>/durian_car/car_drive_view";
  ...
  document.mform.submit();
             ...
             <!---------------------------------- 글쓰기 버튼넣기------------------------------>
              ...
              <tr>
                <td align="right"><a href="<?php echo site_url();?>/durian_car/car_drive_input"><img src="<?php echo $misc;?>img/btn_write.jpg" width="64" height="31" /></td>
              </tr>
              <tr>
                <td height="10"></td>
              </tr>

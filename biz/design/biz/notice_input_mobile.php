	...
	<div width="100%">
		<table class="basic_table">
			...
			<tr>
				...
				<td><input type="text" name="subject" id="subject" class="input-common" style="width:100%;"/></td>
			</tr>
			<tr>
		...
		<div class="btn_div" style="margin-top:20px;">
			...
			<input type="button" class="btn-common btn-color2" style="float:right;width:49%;border-radius:3px;height:40px;" value="등록" onClick="javascript:chkForm();return false;">
		</div>
	</div>
</div>
</form>

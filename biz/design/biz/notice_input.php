            				...
            				<table width="100%" border="0" style="margin-top:20px;">
              				<tr>
                				<td>
                  					...
                  					<tr>
					                    <td height="40" align="center" class="row-color1 border-l" style="font-weight:bold;border-bottom:none;">제목</td>
					                    <td style="padding-left:10px;border-bottom:none;">
															...
															<td align="center" class="border-r" style="border-bottom:none;"><?php echo $name;?></td>
                  					</tr>
														<tr>

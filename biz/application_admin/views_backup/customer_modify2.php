...
//		alert(Number(Number($("#row_max_index").val())));
		...
		$('#person_insert_field_2_1').after("<tr id=" + id + "><td colspan='9' height='1' bgcolor='#e8e8e8'></td></tr><tr id=" + id2 + "><td height='40' align='center' bgcolor='f8f8f9' style='font-weight:bold;'>담당자</td><td height='40' align='center' class='t_border' ><input name='user_branch' type='text' class='input0' id='user_branch' value=''/></td><td height='40' align='center' class='t_border'><input name='user_duty' type='text' class='input0' id='user_duty' value=''/></td><td align='center' class='t_border' ><input name='user_name' type='text' class='input0' id='user_name' value=''/></td><td align='center' class='t_border'><input name='user_tel' type='text' class='input5' id='user_tel' value='' onclick='checkNum(this);' onKeyUp='checkNum(this);'/></td><td align='center' class='t_border' ><input name='user_email' type='text' class='input5' id='user_email' value=''/></td><td align='center' class='t_border'><select name='user_work' id='user_work' class='input5'><option value='영업' selected>영업</option><option value='기술'>기술</option><option value='관리'>관리</option><option value='개발'>개발</option></select></td><td align='center' class='t_border' ><input type='checkbox' name='manager' id='manager' value=''></td><td align='center' class='t_border' ><select name='bill_flag' id='bill_flag' class='input0'><option value='N'>N</option><option value='Y'>Y</option></select></td><td align='center' class='t_border' ><input type='checkbox' name='default_flag1' id='default_flag1' value='Y'/></td><td align='center' class='t_border'><img src='<?php echo $misc;?>img/btn_del0.jpg' style='cursor:pointer;' onclick='javascript:person_list_del(" + $("#row_max_index").val() + ");'/></td></tr>");
	});
});
        ...
        <tr>
			...
			?>
                  ...
                  <tr id="person_insert_field_2_<?php echo $i;?>">
                    <td height="40" align="center" bgcolor="f8f8f9" style="font-weight:bold;">담당자</td>
                    <td height="40" align="center" class="t_border" ><input name="user_branch" type="text" class="input0" id="user_branch" value="<?php echo $item['user_branch'];?>"/></td>
                    ...
                    <td align="center" class="t_border" >
                      <input type="checkbox" name="manager" id="manager" value="<?php echo $item['manager'] ;?>" <?php if($item['manager'] == "Y") { echo "checked"; }?>>
                    </td>

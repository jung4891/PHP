...
<body style=" background:url(../../misc/img/admin_bg.jpg) no-repeat;" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  ...
  <tr>
    <td align="center" valign="middle"><table style="background-color:#FFF; padding:20px; opacity:0.85;" width="485" border="0" cellspacing="0" cellpadding="0">
      ...
      <!-- <tr>
        <td align="center"><table width="460" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><a href="#" onClick="window.open('<?php echo site_url();?>/account/cnum_view/1','','width=550,height=220,scrollbars=no,left=100,top=200');return false" target="space"><img src="<?php echo $misc;?>img/m_btn_newg.jpg" width="225" height="44"></a></td>
            <td width="10"></td>

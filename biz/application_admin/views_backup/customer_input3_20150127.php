  ...
  <tr>
    ...
    <table width="1130" height="100%" cellspacing="0" cellpadding="0" >
        <tr>
           ...
           <div id='cssmenu'>
            <ul>
               <li><a href='<?php echo site_url();?>/account/user'><span>회원정보</span></a></li>
               ...
               <li><a href='<?php echo site_url();?>/company/companynum_list'><span>사업자등록번호</span></a></li>
               <li><a href='<?php echo site_url();?>/company/product_list'><span>제품명</span></a></li>
               <li><a href='<?php echo site_url();?>/customer/customer_list'><span class="point">거래처</span></a></li>
               <li class="last"><a href='<?php echo site_url();?>/customer/sourcing_list'><span>Sourcing Group</span></a></li>
            </ul>
            </div>
            ...
            <table width="890" border="0" style="margin-top:20px;">
             ...
             <!--리스트-->
              <tr>
				...
				<form name="mform" action="<?php echo site_url();?>/customer/customer_input3/<?php echo $seq;?>" method="get">
				...
				<input type="hidden" name="seq" value="">
                  ...
                  <tr>
                    <td height="40" align="center" bgcolor="f8f8f9" style="font-weight:bold;" >번호</td>
...
//}
              ...
              <!--페이징-->
              <tr>
                <td align="center"><?php if ($count > 0) {?>

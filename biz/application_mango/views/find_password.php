...
$(document).ready(function() {
	$("#user_id, #user_email").keydown(function(key) {
		if (key.keyCode == 13) {
			chkForm();
		}
	});
...
<body>
	<div class="main">
		<form class="" name="login" action="<?php echo site_url().'/account/find_password_action';?>" method="post"  onsubmit="javascript:chkForm();return false;">
			<div class="">
					...
					<table style="">
						<tr>
							<th class="login_title">
								...
								<p style="margin-left:35px;">비밀번호 찾기</p>
							</th>
						</tr>
					</table>
				</div>
			...
			<div class="login_input">
				<table class="login_table" border="0" cellspacing="10">
					...
					<tr>
						<td>
							<div>
								<button type="submit" class="login_button" name="login_button">비밀번호 찾기

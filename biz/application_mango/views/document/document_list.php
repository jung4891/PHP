...
function GoSearch(){
	...
	document.mform.action = "<?php echo site_url();?>/document/document_list";
...
<form name="mform" action="<?php echo site_url();?>/document/document_list" method="get" onKeyDown="if(event.keyCode==13) return GoSearch();">
		...
		<tr>
			<td>
				<select name="search1" id="search1" class="select-common">
					<option value="001" <?php if($search1 == "001"){ echo "selected";}?>>서류명</option>
					<option value="002" <?php if($search1 == "002"){ echo "selected";}?>>기안자</option>
					<option value="003" <?php if($search1 == "003"){ echo "selected";}?>>링크</option>
				</select>
				...
				<a style="float:right;" href="<?php echo site_url();?>/document/document_input">
        ...
        <tr>
			...
			?>
                  <tr onMouseOver="this.style.backgroundColor='#FAFAFA'" onMouseOut="this.style.backgroundColor='#fff'" style="<?php echo $read; ?>">
                    ...
                    <td align="center"><a href="JavaScript:ViewBoard('<?php echo $item['seq'];?>')"><?php echo stripslashes($item['document_name']);?></a></td>
                    <td align="left" style="padding-left:10px;"><a href="JavaScript:ViewBoard('<?php echo $item['seq'];?>')"><?php echo $item['url_link'];?></a></td>
...
function ViewBoard (seq){
	...
	document.mform.action = "<?php echo site_url();?>/document/document_view";

...
function chkForm( type ) {
	if(type == 1) {
		if (confirm("정말 삭제하시겠습니까?") == true){
			...
			mform.action="<?php echo site_url();?>/document/document_delete_action";
			mform.submit();
			return false;
		}
	} else {
		var mform = document.cform;
		mform.action="<?php echo site_url();?>/document/document_view";
		mform.submit();
		return false;
	}
}
            ...
            <table width="100%" border="0" style="margin-top:20px;">
									<table class="list_tbl" width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed; word-break:break-all;border: thin solid #DFDFDF;margin-bottom:50px;border-left:none; border-right:none;">
										...
										<tr>
											...
											<td align="left" style="padding-left:10px;">내부서류</td>
	                  ...
	                  <tr>
	                    ...
	                    <td align="left" style="padding-left:10px;"><?php echo stripslashes($view_val['document_name']);?></td>
											<td height="40" class="tbl-title2">등록자</td>
											<td align="left" style="padding-left:10px;"><?php echo $view_val['user_name'];?></td>
	                  </tr>
	                  <tr>
	                    <td height="40" class="tbl-title2" style="vertical-align:top;padding-top:15px;">링크</td>
	                    <td align="left" style="padding-left:10px;vertical-align:top;padding-top:15px;"><?php echo $view_val['url_link'];?></td>
											<td height="40" class="tbl-title2" style="vertical-align:top;padding-top:15px;">첨부파일</td>
											<td align="left" style="padding-left:10px;line-height:200%;">
												<?php
													if($view_val['file_realname'] != ""){
														 ...
														 for($i=0; $i<count($file); $i++){
															 echo "<p>";
																echo $file[$i];
																$href = "{$misc}upload_mango/document/{$file_url[$i]}"; ?>
														<span class="down_btn">

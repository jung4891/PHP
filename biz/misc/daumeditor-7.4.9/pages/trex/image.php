...
<title>이미지 첨부</title>
<link rel="stylesheet" href="http://biz.durianit.co.kr/misc/daumeditor-7.4.9/css/popup.css" type="text/css" charset="utf-8"/>
<link rel="stylesheet" type="text/css" href="http://biz.durianit.co.kr/misc/daumeditor-7.4.9/css/uploadifive.css">
<style type="text/css">
body {
...
<script src="http://biz.durianit.co.kr/misc/daumeditor-7.4.9/js/popup.js" type="text/javascript" charset="utf-8"></script>
<script src="http://biz.durianit.co.kr/misc/daumeditor-7.4.9/js/jquery.uploadifive.min.js" type="text/javascript"></script>
<script type="text/javascript">
    function done() {
        ...
        jQuery(".fileInfo").each(function(idx) {
            ...
            var fileUrl = "http://biz.durianit.co.kr/misc/upload/editor_img/" + fileUpName;
...
jQuery(document).ready(function() {
    jQuery("#file_upload").uploadifive({
        ...
        'uploadScript' : "http://biz.durianit.co.kr/misc/module/uploadifive.php"    // 파일 업로드를 수행할 php 파일

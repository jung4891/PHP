 ...
 * 요청값
 */
$_param['userid'] = 'sylim1284';           // [필수] 뿌리오 아이디
$_param['callback'] = '01041015455';    // [필수] 발신번호 - 숫자만
$_param['phone'] = '01041015455';       // [필수] 수신번호 - 여러명일 경우 |로 구분 '010********|010********|010********'
$_param['msg'] = '테스트 발송입니다';   // [필수] 문자내용 - 이름(names)값이 있다면 [*이름*]가 치환되서 발송됨
// $_param['names'] = '임선영';            // [선택] 이름 - 여러명일 경우 |로 구분 '홍길동|이순신|김철수'

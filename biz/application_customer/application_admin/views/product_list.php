...
function GoSearch(){
	...
	document.mform.action = "<?php echo site_url();?>/company/product_list";
...
<form name="mform" action="<?php echo site_url();?>/company/product_list" method="get" onkeydown="if(event.keyCode==13) return GoSearch();">
        ...
        <tr>
             ...
             <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr bgcolor="f8f8f9" class="t_top">
                    ...
                    <td align="center" class="t_border">제품명</td>
                    <td align="center" class="t_border">제조사</td>
                    <td align="center" class="t_border">품목</td>
                    <td align="center" class="t_border">하드웨어스펙</td>
                  </tr>
                 <tr>
			...
			?>
                 <tr onmouseover="this.style.backgroundColor='#FAFAFA'" onmouseout="this.style.backgroundColor='#fff'" style="cursor:pointer" onclick="ViewBoard('<?php echo $item['seq'];?>')">
                    ...
                    <td  align="center" class="t_border" ><?php echo $this->common->trim_text($item['hardware_spec'], 100);?></td>
                  </tr>
                  <tr>
                    <td colspan="5" height="1" bgcolor="#e8e8e8"></td>
                  </tr>
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/company/product_view";
	...
	document.mform.submit();
		...
		<?php if($at == 777) {?>
              ...
              <!--버튼-->
              <tr>
                <td align="right"><a href="<?php echo site_url();?>/company/product_input" title="작성"><img src="<?php echo $misc;?>img/btn_add2.jpg" width="64" height="31" /></a></td>
              </tr>
              <!--//버튼-->
		<?php }?>
			  <tr>

...
//				'cnumfile_realname' => $filename,
		...
		if($seq == null && $result) {
			echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/customer/customer_input2/".$mdata['seq']."'</script>";
		} else if($seq != null && $result) {
			echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/customer/customer_view2/".$seq."'</script>";
		} else {
	...
	function customer_input_action2() {
		...
		if($mode == 0 && $result) {
			echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/customer/customer_input3/".$seq."'</script>";
		} else if($mode == 1 && $result) {
			echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/customer/customer_view3/".$seq."'</script>";
		} else {
			echo "<script>alert('정상적으로 처리되지 못했습니다. 다시 입력해 주세요.');history.go(-1);</script>";
		}
	}
	...
	function customer_input_action3() {
		...
		if($mode == 0 && $result) {
			echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/customer/customer_input4/".$seq."'</script>";
		} else if($mode == 1 && $result) {
			echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/customer/customer_view4/".$seq."'</script>";
		} else {
			echo "<script>alert('정상적으로 처리되지 못했습니다. 다시 입력해 주세요.');history.go(-1);</script>";
		}
	}
	...
	function customer_input_action4() {
		...
		if($mode == 0 && $result) {
			echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/customer/customer_input5/".$seq."'</script>";
		} else if($mode == 1 && $result) {
			echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/customer/customer_view5/".$seq."'</script>";
		} else {
			echo "<script>alert('정상적으로 처리되지 못했습니다. 다시 입력해 주세요.');history.go(-1);</script>";
		}
	}
...
//					'gfile_realname' =>  $filename5,
		...
		if($mode == 0 && $result) {
			echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/customer/customer_input6/".$seq."'</script>";
		} else if($mode == 1 && $result) {
			echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/customer/customer_view6/".$seq."'</script>";
		} else {
			echo "<script>alert('정상적으로 처리되지 못했습니다. 다시 입력해 주세요.');history.go(-1);</script>";
		}
	}
	...
	function customer_input_action6() {
		...
		if($mode == 0 && $result) {
			echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/customer/customer_list'</script>";
		} else if($mode == 1 && $result) {
			echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/customer/customer_list'</script>";
		} else {
			echo "<script>alert('정상적으로 처리되지 못했습니다. 다시 입력해 주세요.');history.go(-1);</script>";
	...
	function customer_filedel($seq, $filelcname) {
		...
		if (!isset($fdata['bfile_changename'])) {
			...
			alert('파일이 정상적으로 삭제되었습니다.', site_url().'/customer/customer_view5/'.$seq);
		}
	}
	...
	function customer_input2($seq) {
		...
		$data['seq'] = $seq;
		$this->load->Model(array('STC_Customer', 'STC_Common'));
		$this->load->view( 'customer_input2' , $data);
	}
...
//		$data['count'] = $this->STC_Customer->sourcing_list_count($search_keyword, $search1, $search2)->ucount;
		...
		$this->load->view( 'customer_input3' , $data);
	}
	...
	function customer_input4($seq) {
		...
		$data['seq'] = $seq;
		$this->load->Model(array('STC_Customer', 'STC_Common'));
		$this->load->view( 'customer_input4' , $data);
	}
	...
	function customer_input5($seq) {
		...
		$data['seq'] = $seq;
		$this->load->Model(array('STC_Customer', 'STC_Common'));
		$this->load->view( 'customer_input5' , $data);
	}
	...
	function customer_input6($seq) {
		...
		$data['seq'] = $seq;
		$this->load->Model(array('STC_Customer', 'STC_Common'));
		$this->load->view( 'customer_input6' , $data);
	}
	...
	function customer_view() {
		...
		if( $this->id === null ) {
			if($this->cooperative_id <> null){
				if ($_SESSION['timeout'] + 10*60 < time()) {
					...
					echo "<script>location.href='".site_url()."/customer/customer_view2/".$seq."'</script>";
				}
			}else{
				redirect( 'account' );
			}
		...
		$this->load->view( 'customer_modify', $data );
	}
...
//		echo "seq::".$seq."<br>";
		...
		if($strResult == false) {
			echo "<script>alert('입력된 내용이 없습니다. 입력페이지로 이동합니다.');location.href='".site_url()."/customer/customer_input2/".$seq."'</script>";
			exit;
		}
		...
		$this->load->view( 'customer_modify2', $data );
	}
	...
	function customer_view3($seq) {
		...
		if($strResult == false) {
			echo "<script>alert('입력된 내용이 없습니다. 입력페이지로 이동합니다.');location.href='".site_url()."/customer/customer_input3/".$seq."'</script>";
			exit;
		}
...
//		$data['count'] = $this->STC_Customer->sourcing_list_count($search_keyword, $search1, $search2)->ucount;
		...
		$this->load->view( 'customer_modify3', $data );
	}
	...
	function customer_view4($seq) {
		...
		// 거래처 서비스(상품)이 없을경우 입력페이지로 이동
		if($strSupply == false) {
			echo "<script>alert('입력된 내용이 없습니다. 입력페이지로 이동합니다.');location.href='".site_url()."/customer/customer_input4/".$seq."'</script>";
			exit;
		}
		...
		$this->load->view( 'customer_modify4', $data );
	}
	...
	function customer_view5($seq) {
		...
		if($strResult == false) {
			echo "<script>alert('입력된 내용이 없습니다. 입력페이지로 이동합니다.');location.href='".site_url()."/customer/customer_input5/".$seq."'</script>";
			exit;
		}
		...
		$this->load->view( 'customer_modify5', $data );
	}
	...
	function customer_view6($seq) {
		...
		// 거래처 재무정보가 없을경우 입력페이지로 이동
		if($strResult == false) {
			echo "<script>alert('입력된 내용이 없습니다. 입력페이지로 이동합니다.');location.href='".site_url()."/customer/customer_input6/".$seq."'</script>";
			exit;
		}
		...
		$this->load->view( 'customer_modify6', $data );
	}
...
//		$seq = $this->input->post( 'seq' );
		...
		if ($tdata) {
			echo "<script>alert('삭제완료 되었습니다.');location.href='".site_url()."/customer/customer_list'</script>";
		} else {
...
//		$cur_page = $this->input->get( 'cur_page' );			//	현재 페이지
		...
		$this->load->view( 'sourcing_list', $data );
	}
	...
	function sourcing_input_action() {
		...
		if($result) {
			echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/customer/sourcing_list'</script>";
		} else {
			echo "<script>alert('정상적으로 처리되지 못했습니다. 다시 입력해 주세요.');history.go(-1);</script>";
		}
	...
	function sourcing_input() {
		...
		$this->load->Model(array('STC_Customer', 'STC_Common'));
		$data['category'] = $this->STC_Common->get_category();
		$this->load->view( 'sourcing_input', $data );
	}
...
//		$user_id = $this->idx;
		...
		$this->load->view( 'sourcing_modify', $data );
	}
	...
	function sourcing_delete_action() {
		...
		if ($tdata) {
			echo "<script>alert('삭제완료 되었습니다.');location.href='".site_url()."/customer/sourcing_list'</script>";
		} else {
			alert("정상적으로 처리되지 못했습니다.\n다시 시도해 주세요.");
		}
	}

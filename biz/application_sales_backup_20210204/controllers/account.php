	...
	function login( $referer = null ) {
		...
		if( $userid == null || $userpassword == null )
			...
			if($userdata['user_id']){
				...
				//	해당 아이디가 존재하는 경우
				$var = array( 'id' => $userdata['user_id'], 'name' => $userdata['user_name'], 'lv' => $user_level, 'at' => $user_authority, 'pg' => $pageRowNum ,'email' => $userdata['user_email'], 'cnum' => $userdata['company_num'],'group'=>$userdata['user_group'],'pGroupName'=>$userdata['parentGroupName'],'duty'=>$userdata['user_duty']);

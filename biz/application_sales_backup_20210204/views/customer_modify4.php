...
<form name="cform" action="<?php echo site_url();?>/customer/customer_input_action4" method="post" onSubmit="javascript:chkForm();return false;">
            ...
            <table width="1100" border="0" style="margin-top:50px; margin-bottom: 50px;">
             ...
             <tr>
              	<td height="40">
                    ...
                    <li style="float:left;"><a href="<?php echo site_url();?>/customer/customer_view"><img src="<?php echo $misc;?>img/sales_tab_1.jpg" /></a></li>
                    ...
                    <li style="float:left;"><a href="<?php echo site_url();?>/customer/customer_view4/<?php echo $seq;?>"><img src="<?php echo $misc;?>img/sales_tab_4_on.jpg" /></a></li>

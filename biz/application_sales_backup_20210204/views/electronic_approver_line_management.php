                        ...
                        <tr>
                           ...
                           <td>
                              <div id="select_approval_modal" >
                                    <h2>결재선지정</h2>
                                       <div style="background-color:#f8f8f9;margin-top:20px;text-align:lef;">
                                          <?php
                                          if(isset($_GET['seq'])){
                                          ...
                                          ?>
                                          &nbsp;&nbsp; 사용자 결재선명 <input type="text" id="approval_line_name" name="approval_line_name"class="input2" value= "<?php if(isset($_GET['seq'])){echo $line_name;} ?>" style="margin-left:15px;">
                                       </div>
                                       ...
                                       <div>
                                          ...
                                          <?php if(isset($_GET['seq'])){
                                             echo "<img src='{$misc}img/btn_adjust.jpg' style='cursor:pointer;float:right;margin-top:5px;' border=0 onClick='user_approval_line_save(2);'/><br>";
                                          }else{
                                             echo "<img src='{$misc}img/btn_ok.jpg' style='cursor:pointer;float:right;margin-top:5px;' border=0 onClick='user_approval_line_save(1);'/><br>";
                                          }?>
      ...
      if(type == 1){ // 등록 
         $.ajax({
            ...
            success: function (result) {
               if(result){
                  alert("결재선 저장되었습니다.");
                  location.href='<?php echo site_url(); ?>/approval/electronic_approver_line_list'; 
               }else{

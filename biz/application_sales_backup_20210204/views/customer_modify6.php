              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;"><span style="color:#333; font-size:14px;"><input name="rate" type="text" class="input" id="rate" value="<?php echo $view_val['rate'];?>"/></span>&nbsp;&nbsp;&nbsp;&nbsp;<?php if($view_val['file_changename']) {?><a href="<?php echo site_url();?>/customer/customer_download10/<?php echo $seq;?>/<?php echo $view_val['file_changename'];?>"><?php echo $view_val['file_realname'];?></a><?php } ?></td>
                  </tr>

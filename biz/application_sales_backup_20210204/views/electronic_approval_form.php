                                       ...
                                       <table width="100%" class ="basic_table">
                                          <tr >
                                             ...
                                             <td width="85%" height="40" colspan=3 class="basic_td" align="left" style="font-weight:bold;" >
                                                <select  id="default_approval_line" name="default_approval_line" class="input2" onchange='click_user_approval_line(this.value)' >
                                    ...
                                    <div class="content-1">
                                       ...
                                       <table width="100%" class ="basic_table">
                                          <tr >
                                             ...
                                             <td width="35%" class="basic_td" align="left" style="font-weight:bold;" >
                                                <input type="text" class="input2" id="template_name" name="template_name" value="<?php echo $view_val['template_name']; ?>" onchange="$('#approval_info_check').val('N');" />
                                             </td>
                                             <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;" >
                                                <span style="color:red;"> * </span>서식함
                                             </td>
                                             <td width="35%" class="basic_td" align="left" style="font-weight:bold;" >
                                                <select class="input2" id="template_category" name="template_category" onchange = "$('#approval_info_check').val('N');">
                                                   <option value="">미선택</option>
                                                   <?php foreach($category as $format_categroy){
                                          ...
                                          <tr >
                                             ...
                                             <td colspan=3 width="35%" class="basic_td" align="left" style="font-weight:bold;" >
                                                <input type="text" id="template_sort_seq" name="template_sort_seq" class="input5" value="<?php echo $view_val['template_sort_seq'] ;?>" onchange="$('#approval_info_check').val('N');" />&nbsp * 기안문 작성 시 표시되는 양식의 정렬 순서, 숫자가 낮을 수록 상단에 표시됨.
                                             </td>
                                          </tr>
                                          <tr >
                                             <td width="15%" bgcolor="#f8f8f9" class="basic_td" align="center" style="font-weight:bold;" >
                                             ...
                                             <td height="60" colspan=3 width="35%" class="basic_td" align="left" style="font-weight:bold;" >
                                                <textarea id="template_explanation" name="template_explanation" class="input7" onchange="$('#approval_info_check').val('N');" style="height:85%"><?php echo $view_val['template_explanation'] ;?></textarea> 
                                             </td>
                                          </tr>
                                       </table>
                                       <h3>결재선 지정</h3>
                                       <table width="100%" class ="basic_table">
                                          <tr >
                                             ...
                                             <td width="85%" height="40" colspan=3 class="basic_td" align="left" style="font-weight:bold;" >
                                                <select id="default_approval_line" name="default_approval_line" class="input2" onchange="click_user_approval_line(this.value);$('#approval_info_check').val('N');" >
                                       ...
                                       <table width="100%" class ="basic_table">
                                          <tr >
                                             ...
                                             <td width="85%" height=40 colspan=3 class="basic_td" align="left" style="font-weight:bold;" >
                                                <input id="default_referrer" name="default_referrer" type="text" class="input7" value="<?php echo $view_val['default_referrer']; ?>" onchange="$('#approval_info_check').val('N');" />
                                                <img src="<?php echo $misc;?>img/btn_add.jpg" style="cursor:pointer;vertical-align:middle;" border="0" onClick="select_user('default_referrer');"/>
                                             </td>
                                          </tr>
                                       </table><br>
                                    ...
                                    <div class="content-2">
                                       ...
                                       <div class="content-2" style="width:100%">
                                          ...
                                          <div class="content-2" style="width:100%">
                                             ...
                                             <?php if($view_val['form_table_html'] != ""){
      ...
      for (i = 0; i < tr.length; i++) {//tr
         ...
         for (j = 0; j < template.length; j++) {//td
            ...
            if(type == 0){ //구분선
               ...
               if(tr.eq(i).find($('input[name=multi_row]')).length > 0){
                  ...
                  if(multi_row[3] != ""){
                     if(multi_row[3].indexOf(name) != -1){
                        multi_sum += "<td height=40 "+colspan+" class='basic_td'  style='"+td_width+"'><input " + input_type + " id='"+name+"_sum' name='multisum' onchange='regex(this,"+'"money"'+")' class='input7' style='" + width + "' readonly/></td>";
                     }else{
               ...
               if(tr.eq(i).find($('input[name=multi_row]')).length >0){
                  th += "<td height=40 bgcolor='#f8f8f9' align='center' class='basic_td'>"+required_input_display+column_name+"</td>";
                  multi += "<td height=40 class='basic_td'><select class='"+name+" input7' " + essential + ">" + option_html + "</select>"+comment+"</td>";
                  if(multi_row[3] != ""){
                     multi_sum += "<td height=40 class='basic_td'></td>";
                  }
               }else{
                  text += "<td height=40 bgcolor='#f8f8f9' align='center' class='basic_td'>" + required_input_display +column_name + "</td>";
                  text += "<td height=40 class='basic_td'><select class='"+name+" input7' " + essential + ">" + option_html + "</select>"+comment+"</td>";
               }
               ...
               if(tr.eq(i).find($('input[name=multi_row]')).length >0){
                  th += "<td height=40 bgcolor='#f8f8f9' align='center' class='basic_td' >" + required_input_display +column_name + "</td>";
                  multi += "<td height=40 class='basic_td'><div><input class='input2' name='"+name+"' title='"+component+"' placeholder='"+component+"' style='border:none;background:transparent;vertical-align:middle;'/><img src='<?php echo $misc;?>img/btn_add.jpg' style='cursor:pointer;vertical-align:middle;' border='0' onClick='select_"+component+"("+'"'+name+'"'+");'/></div>"+comment+"</td>";
               }else{
                  text += "<td height=40 bgcolor='#f8f8f9' align='center' class='basic_td' >" + required_input_display + column_name + "</td>";
                  text += "<td height=40 class='basic_td'><div><input name='"+name+"' class='input2' title='"+component+"' placeholder='"+component+"' style='border:none;background:transparent;vertical-align:middle;'/><img src='<?php echo $misc;?>img/btn_add.jpg' style='cursor:pointer;vertical-align:middle;' border='0' onClick='select_"+component+"("+'"'+name+'"'+");'/></div>"+comment+"</td>";
               }    
            }
         }
         if(tr.eq(i).find($('input[name=multi_row]')).length > 0){//멀티 있을때
            ...
            if(multi_row[3] != ""){
               multi_sum +="<td align='center' class='basic_td'>"+multi_row[0]+"</td></tr></table></td></tr>"
            }
            html += multi_sum;
         }else{
            text += "</tr>";

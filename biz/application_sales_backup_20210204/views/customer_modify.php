			 ...
			 <!--탭-->
              <tr>
              	<td height="40">
                    ...
                    <li style="float:left;"><a href="<?php echo site_url();?>/customer/customer_view"><img src="<?php echo $misc;?>img/sales_tab_1_on.jpg" /></a></li>
              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                     ...
                     <td align="left" class="t_border" style="padding-left:10px;"><input name="cnum" type="text" class="input" id="cnum" value="<?php echo $view_val['cnum'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);"/> <?php if($view_val['cnumfile_changename']) {?><a href="<?php echo site_url();?>/customer/customer_download/<?php echo $seq;?>/<?php echo $view_val['cnumfile_changename'];?>"><?php echo $view_val['cnumfile_realname'];?></a><?php } else {?>파일없음<?php }?></td>

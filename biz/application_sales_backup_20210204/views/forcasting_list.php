...
function GoSearch() {
  ...
  document.mform.action = "<?php echo site_url();?>/forcasting/forcasting_list";
...
<form name="mform" action="<?php echo site_url();?>/forcasting/forcasting_list" method="get" onkeydown="if(event.keyCode==13) return GoSearch();">
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/forcasting/forcasting_view";

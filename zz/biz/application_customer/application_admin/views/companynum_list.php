...
<form name="mform" action="<?php echo site_url();?>/company/companynum_list" method="get" onkeydown="if(event.keyCode==13) return GoSearch();">
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/company/companynum_view";
	...
	document.mform.submit();
		...
		<?php if($at == "777") {?>
              ...
              <!--버튼-->
              <tr>
                <td align="right"><a href="<?php echo site_url();?>/company/companynum_input" title="작성"><img src="<?php echo $misc;?>img/btn_make.jpg" width="64" height="31" /></a></td>
              </tr>
              <!--//버튼-->
		<?php }?>
			  <tr>

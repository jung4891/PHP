...
function filedel(seq, filename) {
	if (confirm("정말 삭제하시겠습니까?") == true){
		location.href = "<?php echo site_url();?>/biz/document/document_filedel/" + seq + "/" + filename;
		return false;
	}
}
</script>
                				...
                				<td>
                  					...
                  					<tr>
					                    ...
					                    <td style="padding-left:10px;padding-right:10px;">
																<input type="text" name="subject" id="subject" class="input-common" style="width:100%;" value="<?php echo stripslashes($view_val['document_name']);?>"/>
															</td>
                  					...
                  					<tr>
					                    ...
					                    <td style="padding-left:10px;padding-right:10px;border-bottom:none;">
																<input type="text" name="url_link" id="url_link" class="input-common" style="width:100%;" value="<?php echo $view_val['url_link'];?>"/>
															</td>

...
class Board extends CI_Controller {
	...
	function __construct() {
		...
		$this->load->Model(array('admin/STC_Board', 'admin/STC_Common'));
	}
...
//		$cur_page = $this->input->get( 'cur_page' );			//	현재 페이지
	...
	function notice_input() {
		...
		// $this->load->Model(array('STC_Board', 'STC_Common'));
		$data['category'] = $this->STC_Common->get_category();
		$this->load->view('admin/notice_input', $data );
	}
...
//		$user_id = $this->idx;
		...
		if($mode == "view") {
			...
			$this->load->view('admin/notice_modify', $data );
		}
	}
...
//		$cur_page = $this->input->get( 'cur_page' );			//	현재 페이지
		...
		$this->load->view('admin/manual_list', $data );
	}
	...
	function manual_download($seq, $filelcname) {
		...
		$data = file_get_contents("/var/www/html/stc/misc/upload/sales/manual/".$fdata['file_changename']);
	...
	function manual_filedel($seq, $filelcname) {
		...
		if (!isset($fdata['file_changename'])) {
			...
			if($fdata2) {
				unlink("/var/www/html/stc/misc/upload/sales/manual/".$fdata['file_changename']);
			}
	...
	function manual_input_action_image() {
		// $this->load->Model( 'STC_Board' );
		$upload_dir = "/var/www/html/stc/misc/upload/sales/manual/image";
		...
		if( $this->upload->do_upload('upload') ) {
			...
			$data = $this->upload->data();
			$filename = $data['file_name'];
			$url = "/misc/upload/sales/manual/image/".$filename;
			echo "<script type='text/javascript'>window.parent.CKEDITOR.tools.callFunction('".$CKEditorFuncNum."', '".$url."', '전송에 성공했습니다.')</script>";
		} else {
			echo "<script>alert('업로드에 실패했습니다.".$this->upload->display_errors('','')."')</script>";
			exit;
	...
	function manual_input() {
		...
		// $this->load->Model(array('STC_Board', 'STC_Common'));
		$data['category'] = $this->STC_Common->get_category();
		$this->load->view('admin/manual_input', $data );
	}
...
//		$user_id = $this->idx;
		...
		if($mode == "view") {
			$this->load->view('admin/manual_view', $data );
		} else {
			$this->load->view('admin/manual_modify', $data );
		}
	}
...
//		$cur_page = $this->input->get( 'cur_page' );			//	현재 페이지
		...
		$this->load->view('admin/edudata_list', $data );
	}
	...
	function edudata_input() {
		...
		// $this->load->Model(array('STC_Board', 'STC_Common'));
		$data['category'] = $this->STC_Common->get_category();
		$this->load->view('admin/edudata_input', $data );
	}
...
//		$user_id = $this->idx;
		...
		if($mode == "view") {
			$this->load->view('admin/edudata_view', $data );
		} else {
			$this->load->view('admin/edudata_modify', $data );
		}
	}
...
//		$cur_page = $this->input->get( 'cur_page' );			//	현재 페이지
	...
	function faq_input() {
		...
		// $this->load->Model(array('STC_Board', 'STC_Common'));
		$data['category'] = $this->STC_Common->get_category();
		$this->load->view('admin/faq_input', $data );
	}
...
//		$user_id = $this->idx;
		...
		if($mode == "view") {
			...
			$this->load->view('admin/faq_modify', $data );
		}
	}
...
//		$cur_page = $this->input->get( 'cur_page' );			//	현재 페이지
		...
		$this->load->view('admin/suggest_list', $data );
	}
	...
	function suggest_input() {
		...
		// $this->load->Model(array('STC_Board', 'STC_Common'));
		$data['category'] = $this->STC_Common->get_category();
		$this->load->view('admin/suggest_input', $data );
	}
...
//		$user_id = $this->idx;
		...
		if($mode == "view") {
			$this->load->view('admin/suggest_view', $data );
		} else {
			$this->load->view('admin/suggest_modify', $data );
		}
	}
...
//		$cur_page = $this->input->get( 'cur_page' );			//	현재 페이지
	...
	function qna_input() {
		...
		// $this->load->Model(array('STC_Board', 'STC_Common'));
		$data['category'] = $this->STC_Common->get_category();
		$this->load->view('admin/qna_input', $data );
	}
...
//		exit;
		...
		if($mode == "view") {
			$this->load->view('admin/qna_view', $data );
		} else {
			$this->load->view('admin/qna_modify', $data );
		}
	}

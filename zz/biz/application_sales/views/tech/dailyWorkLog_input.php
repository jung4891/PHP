...
<div align="center">
    ...
    <form id="cform" name="cform" action="<?php echo site_url();?>/tech/board/dailyWorkLog_input_action" method="post" enctype="multipart/form-data" onSubmit="javascript:chkForm();return false;">
    		...
    		<tr>
      		<td width="100%" align="center" valign="top">
        			...
        			<tr>
          			...
          			<td class="tbl-cell">
                  <input type="date" style="width:140px;" name="log_date" class="input-common" value="">
                </td>
      ...
      <?php for($i = 0; $i < 4; $i++) { ?>
              <tr class="t_contents">
                <td class="tbl-cell">
                  <input type="text" class="input-common require" name="t_title[]" value="">
                </td>
                <td class="tbl-cell border-l" align="center">
                  <input type="time" class="input-common require" name="t_stime[]" style="width:45%;float:left;">
                  <span style="width:5%;text-align:center;">~</span>
                  <input type="time" class="input-common require" name="t_etime[]" style="width:45%;float:right;">
                </td>
                <td class="tbl-cell border-l" style="padding-top:5px;padding-bottom:5px;">
                  <textarea class="textarea-common require" name="t_content[]"></textarea>
                </td>
      ...
      <?php for($i = 0; $i < 3; $i++) { ?>
              <tr class="n_contents">
                <td class="tbl-cell">
                  <input type="text" class="input-common require" name="n_title[]" value="">
                </td>
                <td class="tbl-cell border-l" align="center">
                  <input type="time" class="input-common require" name="n_stime[]" style="width:45%;float:left;">
                  <span style="width:5%;text-align:center;">~</span>
                  <input type="time" class="input-common require" name="n_etime[]" style="width:45%;float:right;">
                </td>
                <td class="tbl-cell border-l" style="padding-top:5px;padding-bottom:5px;">
                  <textarea class="textarea-common require" name="n_content[]"></textarea>
                </td>
                <td class="tbl-cell border-l">
          <?php if($i == 0) { ?>
      ...
      <?php } ?>
            ...
            <table class="list_tbl" width="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed; word-break:break-all;border: thin solid #DFDFDF;margin-bottom:20px;margin-top:20px;">
              <tr>
                <td class="tbl-cell border-l" style="padding-top:5px;padding-bottom:5px;">
                  <textarea name="etc" class="textarea-common"></textarea>
                </td>
              </tr>
            </table>

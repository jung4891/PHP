...
<body>
  ...
  <script language="javascript">
	...
	function change(){
	  var search1 = document.getElementById("search_select1").selectedIndex;
	  var searchkeyword2 = document.getElementById("searchkeyword_input2");
  ...
  ?>
     ...
     <div class="menu_div">
   		...
   		<a class="menu_list" onclick ="moveList('tech_board/tech_doc_list?type=Y')" style='color:#0575E6'>기술지원보고서</a>
    ...
    <div class="modal_contain" style="font-size:16px; color:#1C1C1C;font-weight:bold;">
      <table style="width:100%;padding:5%;" cellspacing="0">
      		...
      		<td align="left" height="40">
						<select class="select-common" name="search1" id="search_select1" style="margin-right:10px;color:black;width:92%;" onChange="change();">
				...
				<tr>
					<td colspan="2">
						...
						<input type="hidden" id="searchkeyword_input2" class="input-common" placeholder="버전명을 입력하세요." value="<?php echo str_replace('"', '&uml;', $search_keyword2 );?>" style=";width:95%;" />
					</td>
				</tr>
				<tr>
          <td height="20"></td>

...
<div align="center">
	<div class="dash1-1">
		<table width="95%" height="100%" border="0" cellspacing="0" cellpadding="0" class="dash_tbl1-1">
			<form id="cform" name="cform" action="<?php echo site_url();?>/tech/board/study_document_input_action" method="post" enctype="multipart/form-data" onSubmit="javascript:chkForm();return false;">
    		...
    		<tr>
              ...
              <tr>
                ...
                <td class="tbl-cell" colspan="3">
                  <input type="text" name="subject" id="subject" class="input-common" value="<?php echo stripslashes($view_val['subject']); ?>"/>
                </td>
              </tr>
              <tr>
                <td colspan="4">
									<div id="summernote"><?php echo $view_val['content']; ?></div>
...
var request_url = "<?php echo site_url(); ?>/tech/board/study_document_input_action";
var response_url = "<?php echo site_url(); ?>/tech/board/study_document_list";

  ...
  <table id="approval" class="dash_tbl2" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr height="20">
      <td style="float:left" style="padding-left:10px;">
        <img src="<?php echo $misc;?>img/dashboard/btn/btn_2-1_on.png" id="dash_2-1:on" class="btn_on" onclick="change_tbl(this.id);" style="cursor:pointer;"/>
        <img src="<?php echo $misc;?>img/dashboard/btn/btn_2-1_off.png" id="dash_2-1:off" class="btn_off" onclick="change_tbl(this.id);" style="cursor:pointer;display:none;"/>
      </td>
      <td style="float:left" style="padding-left:10px;">
        <img src="<?php echo $misc;?>img/dashboard/btn/btn_2-2_on.png" id="dash_2-2:on" class="btn_on" onclick="change_tbl(this.id);" style="cursor:pointer;display:none;"/>
        <img src="<?php echo $misc;?>img/dashboard/btn/btn_2-2_off.png" id="dash_2-2:off" class="btn_off" onclick="change_tbl(this.id);" style="cursor:pointer;"/>
      </td>
      <td style="float:left" style="padding-left:10px;">
        <img src="<?php echo $misc;?>img/dashboard/btn/btn_2-3_on.png" id="dash_2-3:on" class="btn_on" onclick="change_tbl(this.id);" style="cursor:pointer;display:none;"/>
        <img src="<?php echo $misc;?>img/dashboard/btn/btn_2-3_off.png" id="dash_2-3:off" class="btn_off" onclick="change_tbl(this.id);" style="cursor:pointer;"/>
      </td>
      <td style="float:left" style="padding-left:10px;">
        <img src="<?php echo $misc;?>img/dashboard/btn/btn_2-4_on.png" id="dash_2-4:on" class="btn_on" onclick="change_tbl(this.id);" style="cursor:pointer;display:none;"/>
        <img src="<?php echo $misc;?>img/dashboard/btn/btn_2-4_off.png" id="dash_2-4:off" class="btn_off" onclick="change_tbl(this.id);" style="cursor:pointer;"/>
      </td>
      <td style="float:left" style="padding-left:10px;">
        <img src="<?php echo $misc;?>img/dashboard/btn/btn_2-5_on.png" id="dash_2-5:on" class="btn_on" onclick="change_tbl(this.id);" style="cursor:pointer;display:none;"/>
        <img src="<?php echo $misc;?>img/dashboard/btn/btn_2-5_off.png" id="dash_2-5:off" class="btn_off" onclick="change_tbl(this.id);" style="cursor:pointer;"/>
      </td>
    </tr>
    <tr>
      <td height="10"></td>
    ...
    <tr>
      <td colspan="2" valign="top">
        <table id="tbl_dash_2-5" class="dash_2" width="100%" style="display:none;">
          <tr>
            <td colspan="2" valign="top">
              <table class="content_tbl" align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
                <colgroup>
                ...
                if(empty($reference) != true){
                   $idx = $reference_count-$start_row;
                   for($i = $start_row; $i<$start_row+$end_row; $i++){
                      if(!empty( $reference[$i])){
                         $doc = $reference[$i];
                ?>
                <tr>
                 <td height="40" align="center"><?php echo $idx;?></td>

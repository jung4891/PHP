	...
	<div align="center">
		<div class="dash1-1">
			<table width="95%" height="100%" border="0" cellspacing="0" cellpadding="0" class="dash_tbl1-1">
				<form name="tx_editor_form" id="tx_editor_form" action="<?php echo site_url();?>/biz/dev_request/dev_lab_input_action" method="post" enctype="multipart/form-data" onSubmit="javascript:chkForm();return false;">
                            ...
                            <tr>
                              ...
                              <td height="40" align="center" class="row-color1 border-l border-r" colspan="4" style="font-weight:bold;">상세요청사항</td>
									...
									<tr>
										<td colspan="4">
											<div>
												<br><img src="<?php echo $misc; ?>/img/file_upload.png" style="width:20px;float:left;vertical-align:middle;"><h3 style="float:left;margin:0px;">&nbsp;파일업로드</h3><br>
												<?php
													 $file_html = "";
	                				...
	                				<td>
														<table class="list_tbl" width="100%" border="0" cellspacing="0" cellpadding="0">
															...
															<tr>
															  ...
															  <td style="padding-left:10px;">
																	<select name="progress_step" id="progress_step" class="select-common" style="width:305px;">
                                    <option value="접수대기" <?php if($view_val['progress_step'] == "접수대기") {echo 'selected';} ?> >접수대기</option>
                                    <option value="접수완료" <?php if($view_val['progress_step'] == "접수완료") {echo 'selected';} ?> >접수완료</option>
                                    <option value="개발진행중" <?php if($view_val['progress_step'] == "개발진행중") {echo 'selected';} ?> >개발진행중</option>
                                    <option value="개발완료" <?php if($view_val['progress_step'] == "개발완료") {echo 'selected';} ?> >개발완료</option>
                                    <option value="개발보류" <?php if($view_val['progress_step'] == "개발보류") {echo 'selected';} ?> >개발보류</option>
                                    <option value="반려" <?php if($view_val['progress_step'] == "반려") {echo 'selected';} ?> >반려</option>
                                  </select>
															  </td>
															  <td align="center" class="row-color1" style="font-weight:bold;">담당자</td>
															  <td class="border-r" style="padding-left:10px;">
																	<select name="responsibility" id="responsibility" class="select-common" style="width:305px;">
                                    <option value=""></option>
                                    <option value="김보현" <?php if(isset($view_detail_val['responsibility']) && $view_detail_val['responsibility'] == "김보현") {echo 'selected';} ?> >김보현</option>
                                    <option value="황현빈" <?php if(isset($view_detail_val['responsibility']) && $view_detail_val['responsibility'] == "황현빈") {echo 'selected';} ?> >황현빈</option>
                                    <option value="송혁중" <?php if(isset($view_detail_val['responsibility']) && $view_detail_val['responsibility'] == "송혁중") {echo 'selected';} ?> >송혁중</option>
                                    <option value="조연주" <?php if(isset($view_detail_val['responsibility']) && $view_detail_val['responsibility'] == "조연주") {echo 'selected';} ?> >조연주</option>
                                    <option value="임시진" <?php if(isset($view_detail_val['responsibility']) && $view_detail_val['responsibility'] == "임시진") {echo 'selected';} ?> >임시진</option>
                                 </select>
															  </td>
														  </tr>
														  <tr>
															  ...
															  <td style="padding-left:10px;">
																	<input class="input-common dayBtn" type="date" name="start_date" id="start_date" value="<?php if(isset($view_detail_val['start_date'])) {echo date('Y-m-d', strtotime($view_detail_val['start_date']));} ?>" autocomplete="off" style="width:125px;vertical-align:middle;margin-right:1%;">
															  </td>
																<td align="center" class="row-color1" style="font-weight:bold;">완료예정일</td>
															  <td  class="border-r" style="padding-left:10px;">
																	<input class="input-common dayBtn" type="date" name="expected_end_date" id="expected_end_date" value="<?php if(isset($view_detail_val['expected_end_date'])) {echo date('Y-m-d', strtotime($view_detail_val['expected_end_date']));} ?>" autocomplete="off" style="width:125px;vertical-align:middle;margin-right:1%;">
															  </td>
														  <tr>
														  ...
														  <tr>
																<td colspan="4" style="border-bottom:none">
																	<textarea name="content" id="content" style="display:none;"><?php if(isset($view_detail_val['contents'])) {echo $view_detail_val['contents'];} ?></textarea>
...
var chkForm = function() {
	...
	if(mform.responsibility.value == '') {
		mform.responsibility.focus();
		alert('담당자를 입력해 주세요.');
		return rv = false;
	}
	...
	if(rv) {
		...
		$.ajax({
			url: "<?php echo site_url(); ?>/biz/dev_request/dev_lab_input_action",
			data: formData,
			type: 'POST',

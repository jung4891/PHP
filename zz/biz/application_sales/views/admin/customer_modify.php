...
function chkForm () {
	...
	if (mform.company_name.value.indexOf('㈜') != -1) {
		mform.company_name.focus();
		alert('회사명에 ㈜ 특수 문자를 사용 할 수 없습니다.\n텍스트로 입력해 주세요.');
		return false;
	}
	...
	if($("#company_part").val() != "002"){ // 고객사일땐 필수입력 아냐 ^0^
		if (mform.cnum.value == "") {
			mform.cnum.focus();
...
<div align="center">
  <div class="dash1-1">
		...
		<form name="cform" action="<?php echo site_url();?>/admin/customer/customer_input_action" method="post" enctype="multipart/form-data" onSubmit="javascript:chkForm();return false;">
            ...
            <table width="1100" border="0" style="margin-top:50px; margin-bottom: 50px;">
              	...
              	<td height="40">
                    ...
                    <li style="float:left;">
											<a href="<?php echo site_url();?>/admin/customer/customer_view?seq=<?php echo $seq;?>&mode=modify">
												<img src="<?php echo $misc;?>img/dashboard/btn/btn_tab-1_on.png" />
											</a>
										</li>
              ...
              <tr>
                <td valign="top">
                  ...
                  <colgroup>
                    ...
                    <col width="35%" />
									...
									<tr>
                    <td height="40" colspan="4" align="center" style="font-weight:bold; font-size:16px; padding:10px 0;">업체정보</td>
                  </tr>
                  <tr>
                ...
                <tr>
                  ...
                  <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
										<select name="company_form" id="company_form" class="select7" style="width:255px;">
                      ...
                      <option value="004" <?php if($view_val['company_form'] == "004") { echo "selected"; }?>>외자기업</option>
										...
										<span style="color:#999; font-size:10px;">※중소기업대상:상시고용 근무 종업원수가300인 미만 또는 자본금 80억 미만이 해당됩니다.</span>
									</td>
                </tr>
                <tr>
                  <td colspan="4" height="1" bgcolor="#e8e8e8"></td>
                ...
                <tr>
                  ...
                  <td align="left" class="t_border" style="padding-left:10px;">
										<input name="cnum" type="text" class="input" id="cnum" value="<?php echo $view_val['cnum'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);" maxlength="10"/>
<?php
	if($view_val['cnumfile_changename']) {
?>
									 		<a href="<?php echo site_url();?>/admin/customer/customer_download/<?php echo $seq;?>/<?php echo $view_val['cnumfile_changename'];?>"><?php echo $view_val['cnumfile_realname'];?></a>
<?php
	} else {
?>
											파일없음
...
?>
										<input type="file" name="cnum_file" id="cnum_file" value="<?php echo $view_val['company_name'];?>">
				 					</td>
                  <td height="40" align="center" bgcolor="f8f8f9" style="font-weight:bold;" class="t_border">구매거래 통화</td>
                  <td align="left" class="t_border" style="padding-left:10px;">
										<select name="perchase_part" id="perchase_part" class="select7" style="width:255px;">
                ...
                <tr>
                  ...
                  <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
										<input name="represent_name" type="text" class="input" id="represent_name" value="<?php echo $view_val['represent_name'];?>"/>
									</td>
                </tr>
                ...
                <tr>
                  ...
                  <td align="left" class="t_border" style="padding-left:10px;">
										<input name="company_category" type="text" class="input2" id="company_category" value="<?php echo $view_val['company_category'];?>"/>
										<span style="color:#999; font-size:10px;">사업자등록기준</span>
									</td>
                  <td height="40" align="center" bgcolor="f8f8f9" style="font-weight:bold;" class="t_border">*업종</td>
                  <td align="left" class="t_border" style="padding-left:10px;">
										<input name="company_sector" type="text" class="input2" id="company_sector" value="<?php echo $view_val['company_sector'];?>"/>
										<span style="color:#999; font-size:10px;">사업자등록기준</span>
									</td>
                </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;">
											<input name="establish_date" type="date" class="input2" id="establish_date" style="float:left;" value="<?php echo $view_val['establish_date'];?>" /> <!-- <img src="<?php echo $misc;?>img/btn_calendar.jpg" /> -->
										</td>
                    <td height="40" align="center" bgcolor="f8f8f9" style="font-weight:bold;" class="t_border">진입사유</td>
                    <td align="left" class="t_border" style="padding-left:10px;">
											<input name="entry_reason" id="entry_reason" type="radio" value="N" checked="checked" style=" float:left;" />
											<span style=" display:block; float:left; line-height:18px; padding:0 5px;">신규</span>
											<input name="entry_reason" type="radio" id="entry_reason" value="R" checked="checked" style="float:left;" />
											<span style=" display:block; float:left; line-height:18px; padding:0 5px;">추천</span>
										</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
											<input name="recommand_name" type="text" class="input2" id="recommand_name" value="<?php echo $view_val['recommand_name'];?>"/>
										</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
                    	<input name="cnum_flag" type="radio" value="Y" style=" float:left;" <?php if($view_val['cnum_flag'] == "Y") { echo "checked"; }?>/>
											<span style=" display:block; float:left; line-height:18px; padding:0 5px;">(유)</span>
											<select name="cnum_part1" id="cnum_part1" class="select7" style="float:left; margin-right:10px; width:255px;">
                      	...
                      	<option value="002" <?php if($view_val['cnum_part'] == "002") { echo "selected"; }?>>국내(개인)</option>
										...
										<input name="cnum_flag" type="radio" value="N" style="float:left;" <?php if($view_val['cnum_flag'] == "N") { echo "checked"; }?>/>
										<span style=" display:block; float:left; line-height:18px; padding:0 5px;">(무)</span>
										<select name="cnum_part2" id="cnum_part2" class="select7" style="float:left; width:255px;">
                ...
                <tr>
                  ...
                  <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
                  	<span style="display:block; line-height:35px;">
											<input name="company_post" type="text" class="input2" id="company_post" readonly value="<?php echo $view_val['company_post'];?>"/>
											<input type="button" value="우편번호" class="button" onclick="javascript:openDaumPostcode();" style="cursor:pointer;"/>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<input name="company_addr1" type="text" class="input2" id="company_addr1" readonly value="<?php echo $view_val['company_addr1'];?>"/>
										</span>
                  	<span style="display:block; line-height:35px; height:30px;">
											<input name="company_addr2" type="text" class="input2" id="company_addr2" style="width:615px;" value="<?php echo $view_val['company_addr2'];?>"/>
										</span>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
                  <span style="display:block; line-height:35px;">
										<input name="post_post" type="text" class="input2" id="post_post" readonly value="<?php echo $view_val['post_post'];?>"/>
										<input type="button" value="우편번호" class="button" onclick="javascript:openDaumPostcode2();" style="cursor:pointer;"/>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input name="post_addr1" type="text" class="input2" id="post_addr1" readonly value="<?php echo $view_val['post_addr1'];?>"/>
									</span>
                  <span style="display:block; line-height:35px; height:30px; float:left;">
										<input name="post_addr2" type="text" class="input2" id="post_addr2" style="width:615px;" value="<?php echo $view_val['post_addr2'];?>"/>
									</span>
									<input name="ckbox" type="checkbox" id="ckbox" onclick="javascript:ckbox_check();"value="위와 동일" style="float:left; padding:5px 0 0 10px;" />
									<span style=" display:block; float:left; line-height:22px; padding:0 5px;">위와동일</span>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
										<input name="represent_tel" type="text" class="input2" id="represent_tel" value="<?php echo $view_val['represent_tel'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);"/> <span style="color:#999; font-size:10px;">예) 020000000</span>
									</td>
                </tr>
                ...
                <tr>
                  ...
                  <td align="left" class="t_border" style="padding-left:10px;">
										<input name="represent_handphone" type="text" class="input" id="represent_handphone" value="<?php echo $view_val['represent_handphone'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);"/> <span style="color:#999; font-size:10px;">예) 01000000000</span>
									</td>
                  <td height="40" align="center" bgcolor="f8f8f9" class="t_border" style="font-weight:bold;">*대표 FAX번호</td>
                  <td align="left" class="t_border" style="padding-left:10px;">
										<input name="represent_fax" type="text" class="input2" id="represent_fax" value="<?php echo $view_val['represent_fax'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);"/>
									</td>
                </tr>
                ...
                <tr>
                  ...
                  <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
										<input name="represent_email" type="text" class="input2" id="represent_email" value="<?php echo $view_val['represent_email'];?>"/>
									</td>
                </tr>
                ...
                <tr>
                	<td height="40" align="center" bgcolor="f8f8f9" style="font-weight:bold;">지역코드</td>
									<td align="left" class="t_border" style="padding-left:10px;">
										<select name="local_code" id="local_code" class="select7" style="float:left; width:255px;">
                  ...
                  <td align="left" class="t_border" style="padding-left:10px;">
										<select name="ccountry_code" id="ccountry_code" class="select7" style="float:left; width:255px;">
                ...
                <tr>
                  ...
                  <td align="left" class="t_border" style="padding-left:10px;">
										<select name="bcountry_code" id="bcountry_code" class="select7" style="float:left; width:255px;">
                  ...
                  <td height="40" align="center" bgcolor="f8f8f9" class="t_border" style="font-weight:bold;">은행코드</td>
									<td align="left" class="t_border" style="padding-left:10px;">
										<select name="bank_code" id="bank_code" class="select7" style="float:left; width:255px;">
                ...
                <tr>
                  ...
                  <td align="left" class="t_border" style="padding-left:10px;">
										<input name="bnum" type="text" class="input2" id="bnum" value="<?php echo $view_val['bnum'];?>" onclick="checkNum(this);" onKeyUp="checkNum(this);"/> <?php if($view_val['bnumfile_changename']) {?><a href="<?php echo site_url();?>/admin/customer/customer_download2/<?php echo $seq;?>/<?php echo $view_val['bnumfile_changename'];?>"><?php echo $view_val['bnumfile_realname'];?></a><?php } else {?>파일없음<?php }?> <input type="file" name="bnum_file" id="bnum_file"></td>
                  <td height="40" align="center" bgcolor="f8f8f9" class="t_border" style="font-weight:bold;">예금주</td>
                  <td align="left" class="t_border" style="padding-left:10px;">
										<input name="deposit_name" type="text" class="input2" id="deposit_name" value="<?php echo $view_val['deposit_name'];?>"/>
									</td>
                </tr>
                ...
                <tr>
                  ...
                  <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
										<select name="payment_account" id="payment_account" class="select7" style="float:left; width:255px;">
                ...
                <tr>
                  ...
                  <td align="left" colspan="3" class="t_border" style="padding-left:10px;">
										<select name="tax_part" id="tax_part" class="select7" style="float:left; width:255px;">
                ...
                <tr>
                  <td colspan="4" height="2" bgcolor="#e8e8e8"></td>
                </tr>

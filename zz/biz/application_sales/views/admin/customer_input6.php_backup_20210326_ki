                ...
                <td valign="top">
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;">
											...
											<input name="eval_company" type="text" class="input2" id="eval_company"/>
										</span>
									</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;">
											<span style="color:#333; font-size:14px;">
												<input name="rate" type="text" class="input2" id="rate"/>
											</span>
											&nbsp;&nbsp;&nbsp;&nbsp;
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;">
											<span style="color:#333; font-size:14px;">
												<input name="eval_date" type="text" class="input2" id="eval_date" readonly/>
											</span>
										</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;">
											<span style="color:#333; font-size:14px;">
												<input name="early_date" type="text" class="input2" id="early_date" readonly/>
											</span>
										</td>
                  </tr>
									<tr>

...
<?php foreach ($list_val as $item) {
	...
	?>
				<tr onclick="ViewBoard('<?php echo $item['seq'];?>')">
					<td align="left" style="color:#A1A1A1;"><?php echo $strPart; ?></td>
					<td align="right" style="color:#A1A1A1;"><?php if(trim($item['represent_name']) != ''){echo $item['represent_name'];}else{echo '-';} ?></td>
				</tr>
				<tr onclick="ViewBoard('<?php echo $item['seq'];?>')">
					<td align="left" colspan="2" style="color:#1C1C1C;font-weight:bold;"><?php echo $item['company_name']; ?></td>
				</tr>

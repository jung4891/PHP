...
function chkForm( type ) {
	if(type == 1) {
		if (confirm("등록된 모든 코멘트들도 삭제됩니다. 정말 삭제하시겠습니까?") == true){
			...
			mform.action="<?php echo site_url();?>/sales/board/qna_delete_action";
			mform.submit();
			return false;
		}
	} else {
		var mform = document.cform;
		mform.action="<?php echo site_url();?>/sales/board/qna_view";
		mform.submit();
		return false;
	}
}
...
function chkForm2() {
	...
	rform.action="<?php echo site_url();?>/sales/board/qna_comment_action";
	rform.submit();
	return false;
}
...
function chkForm3(seq) {
	if (confirm("정말 삭제하시겠습니까?") == true){
		...
		rform.action="<?php echo site_url();?>/sales/board/qna_comment_delete";
		rform.submit();
		return false;
	}
}
...
?>
    ...
    <table width="1130" height="100%" cellspacing="0" cellpadding="0" >
        <tr>
            ...
            <table width="1100" border="0" style="margin-top:50px; margin-bottom: 50px;">
              ...
              <tr>
				...
				<input type="hidden" name="mode" value="modify">
                  ...
                  <tr>
                    ...
                    <td width="35%" align="center" class="t_border"><?php echo substr($view_val['update_date'], 0, 10);?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="t_border" style="padding-left:10px;" colspan="3"><?php if($view_val['file_changename']) {?><a href="<?php echo site_url();?>/sales/board/qna_download/<?php echo $seq;?>/<?php echo $view_val['file_changename'];?>"><?php echo $view_val['file_realname'];?></a><?php } else {?>파일없음<?php }?> </td>
                  </tr>
                  <tr>
                  <tr>
                    <td colspan="4" height="2" bgcolor="#797c88"></td>
              ...
              <tr>
                <td align="right"><img src="<?php echo $misc;?>img/btn_list.jpg" border="0" style="cursor:pointer" onClick="javascript:history.go(-1);"/> <?php if($id == $view_val['user_id'] || $sales_lv == 3) {?><img src="<?php echo $misc;?>img/btn_adjust.jpg" style="cursor:pointer" border="0" onClick="javascript:chkForm(0);return false;"/> <img src="<?php echo $misc;?>img/btn_delete.jpg" style="cursor:pointer" border="0" onClick="javascript:chkForm(1);return false;"/><?php }?></td>
              </tr>
              <tr>
                <td></td>
              </tr>
                  ...
                  <tr>
                    <td bgcolor="f8f8f9"><table width="185" border="0" cellspacing="0" cellpadding="5">
                      <tr>
                        ...
                        <td width="10%" align="right"><?php if($id == $item['user_id'] || $sales_lv == 3) {?><img src="<?php echo $misc;?>img/btn_del.jpg" width="18" height="17" style="cursor:pointer" border="0" onClick="javascript:chkForm3('<?php echo $item['seq']?>');return false;"/><?php }?></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
  ...
  <tr>
      ...
      <tr>
        ...
        <td><td><?php include $this->input->server('DOCUMENT_ROOT')."/include/sales_bottom.php"; ?></td></td>
      </tr>
    </table></td>
  </tr>
</table>

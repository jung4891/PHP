...
exec("/usr/local/bin/wkhtmltopdf --encoding UTF-8 -L 19mm -B 10mm http://sales.durianit.co.kr/index.php/approval/electronic_approval_doc_preview?seq={$seq} /var/www/html/stc/misc/upload/sales/electronic_approval/approval_print.pdf");

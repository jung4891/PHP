...
//	}
	...
	document.mform.action = "<?php echo site_url();?>/board/edudata_list";
...
<form name="mform" action="<?php echo site_url();?>/board/edudata_list" method="get" onKeyDown="if(event.keyCode==13) return GoSearch();">
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/board/edudata_view";
	...
	document.mform.submit();
			 ...
			 <?php if($lv == 3) {?>
              ...
              <tr>
                <td align="right"><a href="<?php echo site_url();?>/board/edudata_input"><img src="<?php echo $misc;?>img/btn_write.jpg" width="64" height="31" /></td>
              </tr>
			  <?php }?>
              <tr>
                <td height="10"></td>

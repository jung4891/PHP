...
<body>
<form name="cform" action="<?php echo site_url(); ?>/approval/electronic_approval_delegation_management" method="get" onkeydown="if(event.keyCode==13) return GoSearch();">
                        ...
                        <tr>
                           ...
                           <td> 
                              <table class="basic_table" width="100%" style="font-family:Noto Sans KR">
                                 <tr>
                                    <td width="15%" height=40 bgcolor="f8f8f9" align="right" class="basic_td t_top"><span style="color:red"> * </span>위임할 대상부서</td>
                                 ...
                                 <tr>    
                                    <td width="15%" height=40 bgcolor="f8f8f9" align="right" class="basic_td t_top"><span style="color:red"> * </span>위임기간</td>
                                    <td width="35%" class="basic_td">
                                       <input id="start_date" name="start_date" type="date" class="input"> ~ <input type="date" id="end_date" name="end_date" class="input">
                                    </td>
                                    <td width="15%" height=40 bgcolor="f8f8f9" align="right" class="basic_td t_top"><span style="color:red"> * </span>수임자</td>
                                    <td width="35%" class="basic_td">
                                       <input type="text" id="mandatary" name="mandatary" class="input2" />
                                       <input type="hidden" id="mandatary_seq" name="mandatary_seq"  />
                                       <img src="<?php echo $misc;?>img/btn_add.jpg" style="cursor:pointer;vertical-align:middle;" border="0" onClick="select_user('mandatary');"/>
                                    </td>
                                 </tr>  
                                 <tr>
                                    <td width="15%" height=40 bgcolor="f8f8f9" align="right" class="basic_td t_top"><span style="color:red"> * </span>위임사유</td><td colspan="3" class="basic_td"><input type="text" id="delegation_reason" name="delegation_reason" class="input7"></td>
                                 </tr>
                                 <tr>
                                 </tr>
                              </table>
                              <img src="<?php echo $misc; ?>img/btn_ok.jpg" width="61" style="cursor:pointer;float:right;margin-top:20px;" onclick="delegation_save();">
                              <table class="basic_table" width="100%" style="font-family:Noto Sans KR;margin-top:100px;text-align:center;">
                                 <tr bgcolor="f8f8f9">
                                    <td height="40px" class="basic_td t_top"><input type="checkbox" id='allCheck'></td>
                                    <td class="basic_td t_top">NO</td>
                                    <td class="basic_td t_top">위임할 대상부서</td>
                                    <td class="basic_td t_top">위임기간</td>
                                    <td class="basic_td t_top">수임자</td>
                                    <td class="basic_td t_top">위임사유</td>
                                    <td class="basic_td t_top">설정</td>
                                    <td class="basic_td t_top">결재내역</td>
                                 </tr>
                                 <?php
                              ...
                              <input type="button" class="basicBtn" value="설정해제" style="cursor:pointer;float:right;margin-top:20px;" onclick="unset();"/>                          
                           </td>
                        </tr>
                        <!-- 페이징처리 -->
                        <tr>
   ...
   var result = confirm("위임 하시겠습니까?");
       if (result) {
          $.ajax({
             type: "POST",
             cache: false,
             url: "<?php echo site_url(); ?>/approval/delegation_save",
             dataType: "json",
             async: false,
             data: {
 ...
 function unset(){
   ...
   if(check_seq != ""){
      $.ajax({
         type: "POST",
         cache: false,
         url: "<?php echo site_url(); ?>/approval/delegation_unset",
         dataType: "json",
         async: false,
         data: {
            check_seq: check_seq
...
function detail_view(seq,mendatary,date,reason){
   ...
   $.ajax({
      type: "POST",
      cache: false,
      url: "<?php echo site_url(); ?>/approval/delegation_detail_view",
      dataType: "json",
      async: false,
      data: {
         seq: seq
...
function doc_view(seq){
   window.open("<?php echo site_url(); ?>/approval/electronic_approval_doc_view?seq="+seq, "popup_window", "width = 1200, height = 500, top = 100, left = 400, location = no,status=no,status=no,toolbar=no,scrollbars=no");
}

...
<body>
    <table width="90%" height="100%" cellspacing="0" cellpadding="0" style="padding-left:30px;" >
		...
		<tr>
			<td align="right"><img src="<?php echo $misc;?>img/btn_make.jpg" width="64" height="31" style="margin-top:30px;cursor:pointer;" onclick="location.href='<?php echo site_url();?>/maintain/integration_maintain_input'"/></td>
		</tr>
     </table>
<script>
//통합유지보수 뷰로 이동
function integration_view(seq){
	location.href = "<?php echo site_url();?>/maintain/integration_maintain_view?seq="+seq;
}

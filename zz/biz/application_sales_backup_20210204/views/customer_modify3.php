			 ...
			 <!--탭-->
              <tr>
              	<td height="40">
                    ...
                    <li style="float:left;"><a href="<?php echo site_url();?>/customer/customer_view3/<?php echo $seq;?>"><img src="<?php echo $misc;?>img/sales_tab_3_on.jpg" /></a></li>
              ...
              <tr>
				...
				<form name="mform" action="<?php echo site_url();?>/customer/customer_view3/<?php echo $seq;?>" method="get">
				...
				if ($count > 0) {
					...
					foreach ( $list_val as $item ) {
						...
						if($item['file_changename']) {
							$strFile = "<a href='".site_url()."/customer/customer_download4/".$item['seq']."/".$item['file_changename']."'>".$item['file_realname']."</a>";
						} else {
							$strFile = "-";
						}
...
//}
              ...
              <tr>
				...
				<form name="cform" action="<?php echo site_url();?>/customer/customer_input_action3" method="post" enctype="multipart/form-data" onSubmit="javascript:chkForm();return false;">
				...
				<input type="hidden" name="mode" value="1">
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;"><?php if($view_val['file_changename']) {?><a href="<?php echo site_url();?>/customer/customer_download3/<?php echo $seq;?>/<?php echo $view_val['file_changename'];?>"><?php echo $view_val['file_realname'];?></a><?php } else {?>파일없음<?php }?> </td>
                  </tr>  

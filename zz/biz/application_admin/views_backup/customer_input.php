              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;"><input name="establish_date" type="text" class="input" id="establish_date" style="float:left;" readonly/> <!-- <img src="<?php echo $misc;?>img/btn_calendar.jpg" /> --></td>
                  ...
                  <tr>
                    ...
                    <td align="left" class="t_border" style="padding-left:10px;"><input name="birth_date" type="text" class="input" id="birth_date" style="float:left;" readonly/><!-- <img src="<?php echo $misc;?>img/btn_calendar.jpg" /> --></td>

...
<input type="hidden" name="checksum" value="1">
  <tr>
    ...
    <table width="1130" cellspacing="0" cellpadding="0" >
        ...
        <tr>
            <td height="173"><img src="<?php echo $misc;?>img/admin_title.png" width="197" height="173" /></td>
              ...
              <tr>
				...
				?>
                  <tr onmouseover="this.style.backgroundColor='#FAFAFA'" onmouseout="this.style.backgroundColor='#fff'">
                    <td height="40" align="center"><input type="checkbox" name="scheck[]" value="<?php echo $item['seq'];?>" <?php if (in_array($item['seq'], $strVal)) { echo "checked"; }?>></td>
              ...
              <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="left" colspan="3" class="t_border" style="padding-left:10px;"><?php if($view_val['file_changename']) {?><a href="<?php echo site_url();?>/customer/customer_download3/<?php echo $seq;?>/<?php echo $view_val['file_changename'];?>"><?php echo $view_val['file_realname'];?></a><?php } else {?>파일없음<?php }?> <input name="cfile" type="file" id="cfile"/> </td>
                  </tr>  

...
function GoSearch(){
	...
	document.mform.action = "<?php echo site_url();?>/customer/customer_list";
...
<form name="mform" action="<?php echo site_url();?>/customer/customer_list" method="get" onkeydown="if(event.keyCode==13) return GoSearch();">
        ...
        <tr>
              ...
              <tr>
                <td><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <option value="001" <?php if($search2 == "001"){ echo "selected";}?>>거래처코드</option>
             ...
             <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr bgcolor="f8f8f9" class="t_top">
                    ...
                    <td align="center" class="t_border">거래처코드</td>
                    <td align="center" class="t_border">업체명</td>
                    <td align="center" class="t_border">업체구분</td>
					          <td align="center" class="t_border">사업자번호</td>
                    <td align="center" class="t_border">대표자명</td>
                    <td align="center" class="t_border">회사대표전화</td>
                    <td align="center" class="t_border">대표자 이동전화</td>
                    <td align="center" class="t_border">대표 E-Mail</td>
					          <td align="center" class="t_border">삭제</td>
                  </tr>
                 <tr>
                    <td colspan="10" height="1" bgcolor="#797c88"></td>
                  </tr>
			<?php
				if ($count > 0) {
			...
			?>
                 <tr onmouseover="this.style.backgroundColor='#FAFAFA'" onmouseout="this.style.backgroundColor='#fff'">
                    ...
                    <td align="center" class="t_border"><a href="javascript:ViewBoard('<?php echo $item['seq'];?>');"><?php echo $item['company_name'];?></a></td>
                    <td align="center" class="t_border"><a href="javascript:ViewBoard('<?php echo $item['seq'];?>');"><?php echo $strPart;?></a></td>
                    <td align="center" class="t_border"><a href="javascript:ViewBoard('<?php echo $item['seq'];?>');"><?php echo $item['cnum'];?></a></td>
                    <td align="center" class="t_border"><a href="javascript:ViewBoard('<?php echo $item['seq'];?>');"><?php echo $item['represent_name'];?></a></td>
                    <td align="center" class="t_border"><a href="javascript:ViewBoard('<?php echo $item['seq'];?>');"><?php echo $item['represent_tel'];?></a></td>
                    <td align="center" class="t_border"><a href="javascript:ViewBoard('<?php echo $item['seq'];?>');"><?php echo $item['represent_handphone'];?></a></td>
                    <td align="center" class="t_border"><a href="javascript:ViewBoard('<?php echo $item['seq'];?>');"><?php echo $item['represent_email'];?></a></td>
					<td align="center" class="t_border"><a href="javascript:chkForm2('<?php echo $item['seq'];?>');">삭제</a></td>
                  </tr>
                  <tr>
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/customer/customer_view";
...
function chkForm2(seq) {
	if (confirm("정말 삭제하시겠습니까?") == true){
		...
		mform.action="<?php echo site_url();?>/customer/customer_delete_action/" +seq;
		mform.submit();
		return false;
	}
}
		...
		<?php if($at == "777") {?>
              ...
              <!--버튼-->
              <tr>
                <td align="right"><a href="<?php echo site_url();?>/customer/customer_input" title="작성"><img src="<?php echo $misc;?>img/btn_add2.jpg" width="64" height="31" /></a></td>
              </tr>
              <!--//버튼-->
		<?php }?>
			  <tr>

...
//	}
	...
	document.mform.action = "<?php echo site_url();?>/board/suggest_list";
...
<form name="mform" action="<?php echo site_url();?>/board/suggest_list" method="get" onKeyDown="if(event.keyCode==13) return GoSearch();">
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/board/suggest_view";
	...
	document.mform.submit();
             ...
             <!---------------------------------- 글쓰기 버튼넣기------------------------------>
              ...
              <tr>
                <td align="right"><a href="<?php echo site_url();?>/board/suggest_input"><img src="<?php echo $misc;?>img/btn_write.jpg" width="64" height="31" /></td>
              </tr>
              <tr>
                <td height="10"></td>
              </tr>

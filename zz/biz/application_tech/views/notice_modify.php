...
<script language="javascript">
  function filedel(seq, filename) {
   if (confirm("정말 삭제하시겠습니까?") == true){
    location.href = "<?php echo site_url();?>/board/notice_filedel/" + seq + "/" + filename;
    return false;
  }
}
...
<body>
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <form name="cform" action="<?php echo site_url();?>/board/notice_input_action" method="post" enctype="multipart/form-data" onSubmit="javascript:chkForm();return false;">
      ...
      <td align="center" valign="top">
       ...
       <td width="923" align="center" valign="top">
            ...
            <td colspan="4" style="padding:20px;"><textarea name="contents" id="contents" cols="45" rows="5" class="input4"><?php echo $view_val['contents'];?></textarea>
             <script>
               CKEDITOR.replace( 'contents', {
                filebrowserUploadUrl: '<?php echo site_url();?>/board/notice_input_action_image'
              });
            </script></td>
          </tr><tr>
          <td colspan="4" height="1" bgcolor="#797c88"></td>
        ...
        <tr>
          ...
          <td class="t_border" style="padding-left:10px;" colspan="3"><?php if($view_val['file_changename']) {?><a href="<?php echo site_url();?>/board/notice_download/<?php echo $seq;?>/<?php echo $view_val['file_changename'];?>"><?php echo $view_val['file_realname'];?></a> <a href="javascript:filedel('<?php echo $seq;?>','<?php echo $view_val['file_changename'];?>');"><img src="<?php echo $misc;?>img/del.png" width="8" height="8" /></a>&nbsp;&nbsp;<input name="cfile" id="cfile" type="file" size="78" disabled><?php } else {?><input name="cfile" type="file" size="78"> <span class="point0 txt_s">(용량제한 200MB)<?php }?> </td>
        </tr>
        <tr>
          <tr>
            <td colspan="4" height="2" bgcolor="#797c88"></td>

...
function changekm(){
  ...
  var popup =  window.open('/index.php/biz/durian_car/search_car?carnum='+car_tmp[1]);
  window.focus();
      ...
      <tr>
        <td><table id="input_table" width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="35%" style="padding-left:10px;" class="t_border">
              <input name="a_km" id="a_km" class="input2" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"/>km</td>
             </td>
          </tr>

        ...
        <tr>
			...
			?>
                  <tr onMouseOver="this.style.backgroundColor='#FAFAFA'" onMouseOut="this.style.backgroundColor='#fff'">
                    ...
                    <td style="padding-left:20px;" align="left"><a href="JavaScript:ViewBoard('<?php echo $item['seq'];?>','<?php echo $item['category_code']; ?>')"><?php echo stripslashes($item['subject']);?></a></td>

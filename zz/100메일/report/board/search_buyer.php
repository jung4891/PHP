	...
	<article class="boardArticle">
		...
		<div id="boardList">
			...
			<form name="myform">
							...
							<td class="author">
							<input type="hidden" name="manager"  value="<?php echo $row['manager']?>"><?php echo $row['manager']?></td>
							<td class="date"><?php echo $row['manager_tel']?></td>
							<td class="date2"><input type='submit' value='전송' onclick="submitCharge(<?php echo $i++ ?>);"></td>

<script>

function submitCharge(val){
	//opener.document.form1.customer.value=document.getElementsByTagName('input').item('customer').value;
	//alert(document.getElementsByName('customer')[val-1].value);
	//alert(document.getElementsByName('manager')[val-1].value);
	opener.document.form1.customer.value=document.getElementsByName('customer')[val-1].value;
	opener.document.form1.manager.value=document.getElementsByName('manager')[val-1].value;
	//opener.document.form1.customer.value=document.myform.customer[val].value;
	//opener.document.form1.manager.value=document.myform.manager[val].value;
...
echo $paging ?>
			...
			<div class="searchBox">
				<form action="./search_buyer.php" method="get">

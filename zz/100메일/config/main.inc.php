...
$rcmail_config['default_host'] = 'mail.durianit.co.kr';
...
// For example %n = mail.domain.tld, %t = domain.tld
$rcmail_config['smtp_server'] = 'mail.durianit.co.kr';
...
$rcmail_config['des_key'] = 'Zimr=BhLVZTfSlkpx*Gju68$';
...
$rcmail_config['product_name'] = 'DurianIT Webmail';
...
$rcmail_config['drafts_mbox'] = '임시 보관함';

// store spam messages in this mailbox
// NOTE: Use folder names with namespace prefix (INBOX. on Courier-IMAP)
$rcmail_config['junk_mbox'] = '정크 메일';

// store sent message is this mailbox
// leave blank if sent messages should not be stored
// NOTE: Use folder names with namespace prefix (INBOX. on Courier-IMAP)
$rcmail_config['sent_mbox'] = '보낸 편지함';

// move messages to this folder when deleting them
// leave blank if they should be deleted directly
// NOTE: Use folder names with namespace prefix (INBOX. on Courier-IMAP)
$rcmail_config['trash_mbox'] = '지운 편지함';

// display these folders separately in the mailbox list.
// these folders will also be displayed with localized names
// NOTE: Use folder names with namespace prefix (INBOX. on Courier-IMAP)
$rcmail_config['default_folders'] = array('INBOX', '임시 보관함', '보낸 편지함', '정크 메일', '지운 편지함');
...
switch($_SERVER['SERVER_NAME']) {
	case "mail.durianit.co.kr":
	$rcmail_config['skin'] = 'larry';
	break;
    case "mail.durianit.com":
	$rcmail_config['skin'] = 'larry';
	break;
	case "mail.the-mango.com":
	$rcmail_config['skin'] = 'larry_mango';
	break;
	case "mail.the-mango.co.kr":
	$rcmail_config['skin'] = 'larry_mango';
	break;
	case "mail.durianict.co.kr":
	$rcmail_config['skin'] = 'larry_ICT';
	break;
	case "mail.durianict.com":
	$rcmail_config['skin'] = 'larry_ICT';
	break;
	case "mail.tndsoft.com":
	$rcmail_config['skin'] = 'larry_tnd';
	break;
	case "mail.sodam-design.co.kr":
	$rcmail_config['skin'] = 'larry_sodam';
	break;
	default:
	$rcmail_config['skin'] = 'larry';
	break;

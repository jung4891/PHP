...
<script src="https://mail.durianit.co.kr/misc/daumeditor-7.4.9/js/jquery.uploadifive.js" type="text/javascript"></script>
 ...
 #m_header{
   ...
   width: 100%;
   display: grid;
   grid-template-columns: 10px 35px auto 50px  5px;
   align-items: center;
   column-gap: 5px;
    ...
    <body>
      <div class="write_main">
        <div id="m_header">
            ...
            <div class="img_div">
              <button type="button" class="" name="button" id="submit_button" enctype="multipart/form-data" style="border: none;outline: none;background-color: white;" onclick="chkForm();return false;">
        ...
        <div id="m_main">
          ...
          <table class="" border="0" cellspacing="0" cellpadding="0" style="width:100%;">
            ...
            <tr class="mail_write sender-tr">
                <td style="color:#B0B0B0;font-weight:bold;">받는사람</td>
                <td>
            ...
            <tr class="mail_cc sender-tr">
                <td style="color:#B0B0B0;font-weight:bold;">참조
            ...
            <tr class="mail_bcc sender-tr">
                <td style="color:#B0B0B0;font-weight:bold;">숨은 참조</td>
                <td>
            ...
            <tr class="mail_title sender-tr">
              <td style="color:#B0B0B0;font-weight:bold;">제목
                <!-- <span style="font-size:8px;float:right;padding-right:10px;"><input type="checkbox" name="" value="">중요</span> -->
              </td>
              <td>
                <input type="text" class="input_basic" id="title" name="title" value="<?php echo $reply_title; ?>" placeholder="" style="width:100%; border:1px solid #eee;outline:none;height:28px;">
              </td>
              <td></td>
            </tr>
            <tr class="attachment sender-tr">
                <td style="color:#B0B0B0;font-weight:bold;">첨부
  <img id="toggle_topimg" style="width: 20px;cursor:pointer;position:relative;top: 5px;display:none;" src="<?php echo $misc; ?>/img/toggle_top.svg" alt="" onclick="hide_filediv();">
  <img id="toggle_downimg"  style="width: 20px;cursor:pointer;position:relative;top:5px;" src="<?php echo $misc; ?>/img/toggle_down.svg" alt="" onclick="show_filediv();">
                </td>
                <td style="display: flex;align-items: center;line-height: 30px;">
                  <div class="" style="display:flex;">
                    <div class="file_btn_div" id="" style="border:1px solid #B0B0B0; height:30px;width:100px; border-radius:5px;text-align:center;display:none;">
                      <label id="genenal_filebtn" class="btn_basic btn_white" for="file_up" style="cursor:pointer;display:block;width:100px;text-align:center;display:none;border:none;">
                    ...
                    <div id="" class="file_btn_div" style="display:none;">
                      <div class="" style="display:flex;">
            ...
            <tr class="">
              ...
              <td colspan="2">
                <div id="file_div" class="" style="display:none;">


                <table id="fileTableTbl" class="basic_table" width="100%" style="height:auto;">
              ...
              ?>
              <table class="basic_table" id="fw_filetbl" width="100%" height="auto" style="border:solid 1px #B0B0B0;">
                     ...
                     justify-content: space-between;align-items: center;">
                       ...
                       <form>
                         <div class="" style="display:flex;flex-direction: column;">
                           ...
                           <div id="queue" style="width:100%;height:auto;border:none;">

                           </div>
                             <div id="hiddenFile" class="" style="border: 1px solid #B0B0B0;">
                         ...
                         ?>
                         <span id="expiration_span" style="color: #B0B0B0; font-size:14px; vertical-align:middle; float:left;z-index: 1;">대용량 파일 다운로드 기간 : ~<?php echo $expiration_date; ?></span>
        ...
        <div class="" style="width:100%;overflow-x:scroll;min-height:50%;">
          <select class="" name="" id="signature_list" style="height:30px;border-radius:4px;background-color:white;border-color:#DFDFDF;outline:none;" onchange="sign_select(this.value)">
...
?>
          ...
          <div id="mobile_editor" class="" contenteditable="true">
...
<!-- main_contents 끝 -->
  ...
  function loadContent(){
    var loadContent = $("#content").text();
    $("#mobile_editor").html(loadContent);
  }

  function sign_select(seq){
    var load_content = $("#reply_content").text();
    if(seq =="no"){
      $("#mobile_editor").css({"width" : "unset"});
      var content = "<p><br></p>";
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        $("#content").text(content).html();
        loadContent();
        $("#mobile_editor").css({"width" : "max-content"});
      }
    });
  }
...
function selectFile(files){
    ...
    if(files != null){
        ...
        $("#fileTableTbl").css({"border" : "solid 1px #B0B0B0"});
    }else{
        alert("ERROR");
    }
}
...
var chkForm = function () {
  ...
  if (mform.recipient.value == "") {
    ...
    $("#contents").val($("#mobile_editor").html());

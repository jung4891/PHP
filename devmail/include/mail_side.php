...
<div id="main">
    <div id="sideBar">
      ...
      <br>
      <div class="">
          <a href="<?php echo site_url(); ?>/mailbox/mail_list?boxname=inbox&type=unseen">
            <img src="<?php echo $misc;?>img/icon/schedule.svg" width="20">안읽음</a>
          <a href="<?php echo site_url(); ?>/mailbox/mail_list?boxname=inbox&type=important">
            <img src="<?php echo $misc;?>img/icon/schedule.svg" width="20"> 중요</a>
          <a href="<?php echo site_url(); ?>/mailbox/mail_list?boxname=inbox&type=attachments">
      ...
      <div class="">
        <div class="">
          <a href="<?php echo site_url(); ?>/option"><img src="<?php echo $misc;?>img/icon/schedule.svg" width="20">설정</a>
        </div>
      </div>
    </div>
    <div id="sideMini">

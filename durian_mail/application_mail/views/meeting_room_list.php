...
<div align="main_contents">
	<div class="dash1-1">
		...
		<form name="mform" action="<?php echo site_url();?>/equipment/meeting_room_list" method="get" onkeydown="if(event.keyCode==13) return GoSearch();">
...
function ViewBoard (seq){
	document.mform.action = "<?php echo site_url();?>/equipment/meeting_room_view";
...
<div id="meeting_room_input" style="display:none; position: absolute; background-color: white; width: 400px; height: 290px; border-radius:5px;">
  <form name="cform" id="cform" action="<?php echo site_url();?>/equipment/meeting_room_input_action" method="post" onSubmit="javascript:chkForm();return false;" enctype="multipart/form-data">
    <table style="margin:10px 30px; border-collapse: separate; border-spacing: 0 30px;">
      ...
      <tr>
				<td align="left" valign="center" style="font-weight:bold;">회의실명</td>
				<td align="left">

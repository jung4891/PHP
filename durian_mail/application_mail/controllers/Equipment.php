...
class Equipment extends CI_Controller {
   ...
   function __construct() {
      ...
      // $this->load->Model(array('STC_Common', 'STC_Equipment'));
   ...
   function car_delete_action() {
      ...
      if ($tdata) {
         echo "<script>alert('삭제완료 되었습니다.');location.href='".site_url()."/equipment/car_list'</script>";
      } else {
   ...
   function meeting_room_list() {
      ...
      $this->load->view('meeting_room_list', $data );
   }
   ...
   function meeting_room_input() {
     ...
     $this->load->view('meeting_room_input');
   }
   ...
   function meeting_room_input_action() {
      ...
      if($result) {
         echo "<script>alert('정상적으로 처리되었습니다.');location.href='".site_url()."/equipment/meeting_room_list'</script>";
      } else {
         echo "<script>alert('정상적으로 처리되지 못했습니다. 다시 입력해 주세요.');history.go(-1);</script>";
      }
   ...
   function meeting_room_view() {
      ...
      $this->load->view('meeting_room_modify', $data );
   }
